...
1. Liferay 승인 URL에 `http://localhost:8080/o/oauth2/authorize` 입력합니다. 클립보드에서 클라이언트 ID를 붙여넣습니다. _승인_클릭합니다.
...
1. Liferay 토큰 URL에 `http://localhost:8080/o/oauth2/token` 을 입력합니다. 클립보드에서 클라이언트 ID와 클라이언트 암호를 붙여넣습니다. _토큰 받기_클릭합니다. 향후 REST API 호출을 만드는 데 사용할 수 있는 권한 부여 토큰이 나타납니다.
