...
## Developer Settings
 ...
 | `theme.css.fast.load.check.request.parameter=true`                        | Allows enabling and disabling merging the theme's CSS files through a request parameter.                                                                                                                                         |
 | `theme.images.fast.load=false`                                            | Disables merging the theme's image files to facilitate debugging.                                                                                                                                                                |
 | `theme.images.fast.load.check.request.parameter=true`                     | Allows enabling and disabling merging the theme's image files through a request parameter.                                                                                                                                       |
