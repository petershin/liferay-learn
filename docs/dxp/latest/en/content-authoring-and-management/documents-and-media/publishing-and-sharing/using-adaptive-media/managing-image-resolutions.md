...
1. Click the *Actions* button ( ![Actions Button](../../../../images/icon-actions.png) ) for the desired resolution and select *Adapt Remaining*.

   ![Select Adapt Remaining.](./managing-image-resolutions/images/02.png)

   Alternatively, you can click the *Actions* button ( ![Actions Button](../../../../images/icon-actions.png) ) in the Application Bar and select *Adapt All Images* to begin generating images for all enabled resolutions.
...
To disable/reenable a resolution,

1. Click the *Actions* button ( ![Actions Button](../../../../images/icon-actions.png) ) for the desired resolution.
...
If you upload images and later reenable a resolution, you must [manually generate](#manually-generating-adapted-images) adapted images for them.
...
```{warning}
Be careful when deleting image resolutions. Once deleted, the resolution's adapted images are irretrievably lost and are not automatically replaced by new image resolutions you create.
```

To delete an image resolution,

1. Click the *Actions* button ( ![Actions Button](../../../../images/icon-actions.png) ) for a disabled resolution.
