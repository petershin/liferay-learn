...
이 섹션에는 현재 사용 가능한 각 배틀카드에 대한 간략한 리뷰가 포함되어 있습니다. 이는 심층 분석을 위한 것이 **아닙니다** . 모든 세부 정보를 보려면 배틀카드 자체를 다운로드하십시오.

Acquia, Adobe, Optimizely 및 Sitecore는 레벨 0 모듈에서 다루는 [4개의 주요 경쟁사](../../level-0/main-competitors-faced-by-liferay.md)입니다.
...
* Drupal은 견고한 기반을 유지하는 대신 너무 빨리 "더 크고 더 나은" 것을 시도하는 것으로 알려져 있습니다. 지원이 부족하고(현재 고객에 따르면), 학습 곡선이 가파르고, 업그레이드가 매우 어렵고, 몇 달(또는 몇 년!)이 걸릴 수 있습니다. 버그를 수정하려면.
...
* 이 전투 카드는 **순수한** 로우 코드 또는 노 코드 솔루션의 개념을 취하고 있으며, 로우 코드/노 코드 기능을 갖춘 Liferay와 같은 제품을 사용하는 것이 훨씬 더 좋을 수 있다고 생각하는 이유는 무엇입니까? 조직의 문제에 대한 해결책.
...
* SAP는 **다른** SAP 제품과 잘 통합되지만 다른 시스템과 통합하기는 어렵습니다.  SAP를 독점적으로 사용하는 회사는 거의 없기 때문에 이로 인해 심각한 문제가 발생할 수 있습니다.

### 블룸리치

* Bloomreach는 모든 접점에서 상거래 경험을 관리하는 방식을 변화시키려는 디지털 상거래 및 마케팅 전문가에게 서비스를 제공하고자 합니다.
* Bloomreach는 **주로** B2C 및 B2B 시장의 디지털 상거래 중심 사용 사례에 중점을 두고 있습니다.
...
다음: [배틀카드의 구조](./battlecard-format.md)를 이해합니다.
