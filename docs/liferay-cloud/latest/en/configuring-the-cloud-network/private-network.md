...
```{tip}
If you expose a connection to external connections, then you may need to troubleshoot the connection using your service's shell. See [Shell Access](../support-and-troubleshooting/troubleshooting-tools-and-resources/shell-access.md) for more information.
```
