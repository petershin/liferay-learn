...
ポートレットコンポーネントが*view-template*のリストを作成していない場合、通常、MVCRenderCommandがエントリ.jspファイルにディスパッチしていることを意味します。*BlogsViewMVCRenderCommand*は、/と/blogs/viewの両方に対して、*/blogs/view.jsp*へのディスパッチを処理します。
