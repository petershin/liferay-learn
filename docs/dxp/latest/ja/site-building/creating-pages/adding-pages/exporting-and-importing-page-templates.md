...
1. 目的のコンテンツページテンプレートの **Actions**(![Actionsボタン](../../../images/icon-actions.png))をクリックし、 **Export** を選択します。
...
1. アプリケーションバーの **オプション**(![オプションアイコン](../../../images/icon-options.png))をクリックし、 **インポート** を選択します。
...
1. 別のファイルをインポートするには、 **Upload Another File** をクリックするか、ページテンプレートのページに戻るには、 **Done** をクリックしてください。
