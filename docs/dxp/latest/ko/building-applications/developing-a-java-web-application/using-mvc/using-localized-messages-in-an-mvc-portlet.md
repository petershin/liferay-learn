...
[Liferay 태그 라이브러리 참조](https://resources.learn.liferay.com/reference/latest/en/dxp/taglibs/util-taglib/index.html) 에서 태그 라이브러리에 대해 자세히 알아보십시오. 각 태그 라이브러리에는 태그에 전달할 수 있는 속성 목록이 있습니다.
