...
Liferay クラウドには、 [プライベートネットワーク](../configuring-the-cloud-network/private-network.md) 、パブリック [ロードバランサー](../configuring-the-cloud-network/load-balancer.md) ( [レイヤー7](https://www.nginx.com/resources/glossary/layer-7-load-balancing/) )、 [CDN](../configuring-the-cloud-network/load-balancer.md#cdn) などのネットワークセキュリティ機能が追加されています。
...
* [プライベート・ネットワーク](../configuring-the-cloud-network/private-network.md)
