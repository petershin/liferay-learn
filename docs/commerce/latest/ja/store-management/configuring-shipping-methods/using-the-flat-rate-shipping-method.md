...
一律料金配送では、カタログ内のすべての商品に同じ費用がかかります。 ただし、商品の[［設定］](../../inventory-management/-guide.md)タブの ［**配送追加費用**］ フィールドから個々の商品について例外を作成できます。
...
* [配送方法の制限を適用する](./applying-shipping-method-restrictions.md) 
