...
* **古いログへのアクセス**： デフォルトでは、各サービスの過去30日分のログがコンソールから利用できます。より古いアプリケーションログ（最大1年前まで）にアクセスするには、[サポートリクエストを送信](https://help.liferay.com/)してください。ステータスログとビルドログは、30日を過ぎると取得できなくなります。
