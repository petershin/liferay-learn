...
1. 왼쪽 탐색 메뉴에서 _메일 설정_을 클릭합니다. 다음 구성을 설정합니다.
...
1. 왼쪽 탐색 메뉴에서 _Outlook Auth Connector_클릭합니다. 클라이언트 ID, 클라이언트 암호 및 테넌트 ID를 각 입력 상자에 붙여넣습니다.

    ![테넌트 ID, 클라이언트 ID 및 클라이언트 암호 값을 각 입력 상자에 붙여넣습니다.](./configuring-office-365-with-oauth/images/01.png)

1. _POP3 연결 활성화_ 및 _SMTP 연결 활성화_확인란을 선택합니다.
