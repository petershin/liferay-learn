...
* [7.4의 유지 관리 모드 및 더 이상 사용되지 않음](./reference/maintenance-mode-and-deprecations-in-7-4.md)
* [7.3의 유지 관리 모드 및 더 이상 사용되지 않음](./reference/maintenance-mode-and-deprecations-in-7-3.md)
* [7.2의 유지 관리 모드 및 더 이상 사용되지 않음](./reference/maintenance-mode-and-deprecations-in-7-2.md)
* [언어 키 이름 변경](./reference/renamed-language-keys.md)
