...
詳細は、 [検索ページの構成](../search-pages-and-widgets/working-with-search-pages/search-pages.md) または [検索ページとウィジェット](../search-pages-and-widgets/working-with-search-pages.md)を参照してください。
...
詳細は、 [検索の管理とチューニング](../search-administration-and-tuning.md)をご覧ください。
