...
!!! tip
    You can test the connectivity of your services to an IP address manually through your VPN by using the service's [shell](../../support-and-troubleshooting/shell-access.md) to run a command like the following: `curl -v [address]`.
