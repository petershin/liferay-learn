...
여러분이 알고 있는 도구와 프레임워크를 사용하여 Liferay DXP용 멋진 애플리케이션을 구축하는 방법에는 여러 가지가 있습니다. Liferay DXP 7.4에는 코드를 작성하거나 모듈을 배포하지 않고도 비즈니스 애플리케이션을 만드는 데 사용할 수 있는 [객체](building-applications/objects.md) 이 도입되었습니다.
