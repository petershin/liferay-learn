...
Initially, you'll populate the Home and Search pages with content. Most of the others will be populated during the Content Management module. The Shop page is a placeholder for the Commerce Architect course. Begin by repurposing the default Home page of the site, then move into creating and configuring the site's pages.

## Editing Content Pages

There are several page types in Liferay, but [content pages](https://learn.liferay.com/en/w/dxp/site-building/creating-pages/using-content-pages) are the default and the one used most often. Content pages provide a convenient user interface for managing and editing page content and design. You'll design Clarity's pages primarily through fragments, but also through widgets, which are added to content pages. 

![Use the content page editor to add fragments and widgets to the page.](./creating-pages/images/01.png)

## Using Fragments

[Fragments](https://learn.liferay.com/en/w/dxp/site-building/creating-pages/page-fragments-and-widgets/using-fragments) are reusable snippets of HTML, JavaScript (if necessary), and CSS that you add to content pages to build the look-and-feel and add content. You'll use both handy out-of-the-box fragments and custom fragments to build the Clarity site. Whether custom or built-in, *fragment compositions* are exportable collections of fragments that you can re-use across pages, sites, and systems.
...
You'll build Clarity's navigation menus with the [Navigation Menus application](https://learn.liferay.com/en/w/dxp/site-building/site-navigation/using-the-navigation-menus-application) and displayed them using the [Menu Display fragment or widget](https://learn.liferay.com/en/w/dxp/site-building/site-navigation/configuring-menu-displays). In the page header, the page hierarchy will help users navigate the site.
