...
| [Object Views](creating-and-managing-objects/views/designing-object-views.md)                 | Only used with the object's widget, you can use views to customize the creation and edit form. | Creation screen<br>Edit screen |
