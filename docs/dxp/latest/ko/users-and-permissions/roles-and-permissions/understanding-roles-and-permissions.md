...
역할 생성 및 사용자 지정으로 바로 건너뛰려면 다음을 참조하십시오.
...
예를 들어 _Message Boards Admin_ 역할 및 사용자 _Jane Slaughter_ 사용하여 수행할 수 있는 단계는 다음과 같습니다.
...
Liferay DXP의 페이지에 있는 각 위젯 인스턴스와 사이트 메뉴 &rarr; 콘텐츠 및 데이터 섹션의 각 관리 응용 프로그램에 대한 권한을 부여할 수 있습니다. 자세한 내용은 [위젯 권한](./../../site-building/creating-pages/using-widget-pages/configuring-widgets/setting-widget-permissions.md) 참조하십시오.

### 자산 범위 권한

자산 수준 권한(예: 개별 블로그 게시물을 편집하거나 문서 및 미디어 라이브러리의 폴더를 볼 수 있는 권한)은 제어판이 아닌 개별 자산에서 관리됩니다. 자세한 내용은 [위젯 권한](./../../site-building/creating-pages/using-widget-pages/configuring-widgets/setting-widget-permissions.md) 참조하십시오.
