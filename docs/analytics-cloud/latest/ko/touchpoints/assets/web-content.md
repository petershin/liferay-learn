...
**세그먼트 보기:** 하나 이상의 Analytics Cloud 세그먼트에 속하거나 속하지 않은 알려진 개인의 백분율을 나타내는 도넛형 차트입니다. 센터는 알려진 개인의 총 수를 보여줍니다. 총 수에는 세분화 기준에 따라 일부 익명의 개인이 포함될 수 있습니다. 도구 설명에는 해당 섹션의 사용자 수(예: 하나 이상의 세그먼트에 속한 사용자 수)가 표시됩니다.
