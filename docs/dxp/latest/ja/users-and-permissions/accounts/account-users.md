...
1. グローバルメニュー（![Global Menu](../../images/icon-applications-menu.png)）を開きます。 **コントロールパネル** &rarr; **アカウント ユーザー** に移動します。
...
アカウントユーザーになりすまして、その人が見ているようにシステムを見ることができます。 これは、ユーザーが制限されたデータにアクセスできないことを確認するなど、管理者が見ることのできない権限の問題を診断するために使用されます。 この権限を持つユーザーだけが、別のユーザーになりすますことができます。
