...
Each session lists out [individual events](../../touchpoints/events.md) that are tracked by Analytics Cloud including both [default events](../../workspace-data/definitions.md#default-events) and [custom events](../../workspace-data/definitions.md#custom-events). Click on any event to see the event's details (e.g. page tile and url).
