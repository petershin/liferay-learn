...
| 사용 사례                                                               | `구성` (**값**) |
|:------------------------------------------------------------------- |:--------------------------------------------------------------------------------------------------------------------------- |
| **사용자 제목 필터:** 최종 사용자는 필터 키를 직접 조작하여 제목을 사용하여 원하는 결과로 결과를 구체화합니다.   | `Filter Field` **(title\_en\_US)** <br /> `Filter Value` (**podcast**) <br /> `Filter Query Type` (**Match**) <br /> `Occur Type` (**must_not**) |
