...
1. **グローバルメニュー**(![グローバルメニュー](../../images/icon-applications-menu.png))を開き、［**コントロールパネル** ］ タブから*［**セキュリティツール**］をクリックします。
