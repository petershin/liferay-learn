...
1. 세부 정보 탭에서 *위젯* 표시/숨기기 스위치를 토글합니다.

   ![위젯 표시/숨기기 스위치를 전환합니다.](./deploying-object-widgets-to-sites/images/01.png)

1. *저장*을 클릭합니다.

스위치가 *으로 전환되고 위젯 표시* 개체가 게시되면 즉시 [사이트 페이지에 위젯을 추가할 수 있습니다](#adding-the-widget-to-pages).

그러나 스위치가 *Hide Widget*로 토글되면 위젯 메뉴에서 숨겨지며 페이지에 추가할 수 없습니다.
