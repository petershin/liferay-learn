...
Tokens defining the options for configuring your style book are grouped into categories. They appear as options in the drop-down menu when you are editing your style book.
...
Each category is further organized into *token sets* which correspond to the collapsible groups of options that appear when you are editing a style book.
...
Define the tokens within each token set's `frontendTokens` field. Here is a list of all the properties you can use for your tokens:
