...
1. 目的のObjectフィールドに対応するフォームフィールドを追加する。

   各タイプの Object フィールドと互換性のあるフォーム フィールドのリストについては、「 [Field Compatibility Reference」（英語）](#field-compatibility-reference) を参照してください。
...
1. フォームレイアウトをデザインします。 この処理の詳細については、 [Forms](../../process-automation/forms.md) のドキュメントを参照してください。
