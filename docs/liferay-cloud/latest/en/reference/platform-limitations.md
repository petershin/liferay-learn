...
!!! note
    Liferay mitigates the effects of session loss through various strategies such as cookies and database interactions. This ensures items like [Commerce carts](https://learn.liferay.com/w/commerce/creating-store-content/commerce-storefront-pages/cart) are saved even when the session is lost.
