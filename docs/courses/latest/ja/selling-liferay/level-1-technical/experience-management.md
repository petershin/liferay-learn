...
[](https://learn.liferay.com/dxp/latest/en/site-building/creating-pages/understanding-pages/understanding-pages.html) Liferay DXP はユーザーにコンテンツやアプリケーションを表示するために使用される主要な方法です。
...
* [コンテントページの使用](https://learn.liferay.com/dxp/latest/en/site-building/creating-pages/using-content-pages.html)
...
* [フラグメントの使用](https://learn.liferay.com/dxp/latest/en/site-building/creating-pages/page-fragments-and-widgets/using-fragments.html)
