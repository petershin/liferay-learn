...
```{note}
この情報はLiferay DXP 7.3以降に適用されます。 Liferay DXP の以前のバージョンについては、 [Liferay DXP 7.2](#liferay-dxp-7-2) をご覧ください。
```
...
動的コンテンツセットを使用すると、セット内のアイテムの **ソース** 、 **スコープ** 、 **絞り込み** 、および **順序付け** を選択できます。
