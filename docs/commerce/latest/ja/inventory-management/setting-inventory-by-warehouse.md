...
複数の倉庫を持つ店舗は、倉庫ごとに商品在庫管理できます。 _Inventory_ メニューは、ユーザーが各倉庫で販売可能な商品の数を管理する場所です。 [Minium Accelerator](../starting-a-store/using-the-minium-accelerator-to-jump-start-your-b2b-store.md)を使用してストアが作成された場合は、すでに3つの倉庫が作成されています。
...
商品とそのサブメニューの管理は、 _コントロールパネル_で行います。
