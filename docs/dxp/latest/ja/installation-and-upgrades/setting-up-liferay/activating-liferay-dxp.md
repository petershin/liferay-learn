...
ライセンスマネージャのページには、サーバーとライセンスの情報が表示されます。 このページを表示するには、アクティベーションページで **License Manager** をクリックします。 または、以前に Liferay インスタンスをアクティベートしている場合は、管理者としてログインし、 **コントロールパネル** &rarr; **ライセンスマネージャ** に移動します。
