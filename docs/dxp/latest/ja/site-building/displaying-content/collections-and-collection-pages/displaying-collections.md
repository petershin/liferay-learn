...
1. クリックオプション ( ![オプション](../../../images/icon-app-options.png) ) &rarr; トップアセットパブリッシャーの **設定** です。
...
1. オプション(![オプション](../../../images/icon-app-options.png))をクリックします。 &rarr; 一番下のアセットパブリッシャーの **設定** をクリックします。
...
1. **Space Program Images** をクリックするか、![Options](../../../images/icon-options.png) &rarr; Space Program Imagesの隣にある **Edit** を選択する。
