...
| **編集**                                                   | このオプションは、編集可能な文書に対してのみ有効です（`doc`、`docx`、`txt`）。 ファイルの名前、説明、ドキュメントタイプ、分類、および[関連アセット](https://help.liferay.com/hc/articles/360028820532-Defining-Content-Relationships)を変更します。 新しいファイルをアップロードして置き換えることもできます。 ファイルを変更すると、そのバージョンが上がることに注意してください。 |
...
| **権限の設定**                                                | 各ロールがファイルに対して実行できるアクションを指定します。                                                                                                                                                                                                                |
| **[ゴミ箱](../../recycle-bin/recycle-bin-overview.md)へ移動：** | ファイルをドキュメントとメディアライブラリからゴミ箱に移動します。                                                                                                                                                                                                             |
...
|:------------------ |:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **所有者**            | ファイルの所有者。                                                                                                                                                                                                                  |
| **ダウンロード**         | ファイルをダウンロードするためのボタン。                                                                                                                                                                                                       |
| **最新バージョンのURL**    | ファイルの最新バージョンにアクセスするためのURL。                                                                                                                                                                                                 |
