...
이전에는 [Liferay 소스 코드](https://github.com/liferay/liferay-portal/) 내에서 테스트 파일을 다운로드하고 생성해야만 Poshi 테스트를 실행할 수 있었습니다. _Poshi Standalone_ gradle 프로젝트를 사용하면 전체 Liferay Portal github 리포지토리를 가져오지 않고도 원하는 디렉터리에서 Poshi를 사용할 수 있습니다.
