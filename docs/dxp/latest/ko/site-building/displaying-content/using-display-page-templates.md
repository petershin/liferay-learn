...
![단일 표시 페이지 템플릿을 사용하여 같은 유형의 다른 콘텐츠에 같은 레이아웃을 적용할 수 있습니다.](./using-display-page-templates/images/02.png)
