...
1. **グローバルメニュー**（![Global Menu](../../../../images/icon-applications-menu.png)）を開き、 ［**コントロールパネル**］ タブをクリックして、 ［**System Settings**］ &rarr; ［**Documents and Media**］ に移動します。

1. ［ Virtual Instance Scope］の下の ［**Google Drive**］ をクリックします。

    ![［仮想インスタンススコープ］の下の［Google ドライブ］をクリックします。](./enabling-links-to-google-drive-documents/images/01.png)

1. プロジェクトのOAuth 2.0の **クライアントID** と **クライアントシークレット** を入力します。
...
1. ［Documents and Media］タブで **追加** ボタン（![Add Button](../../../../images/icon-add.png)）をクリックし、 ［**Google Drive Shortcut**］ を選択します。
