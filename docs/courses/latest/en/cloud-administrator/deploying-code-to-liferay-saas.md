...
[Client extensions](https://learn.liferay.com/w/dxp/building-applications/client-extensions) are the comprehensive means of extending Liferay SaaS. You can deploy client extensions to [import batch data](https://learn.liferay.com/w/dxp/building-applications/client-extensions/batch-client-extensions), host [static frontend resources for your site](https://learn.liferay.com/w/dxp/building-applications/client-extensions/frontend-client-extensions), or even [integrate with custom microservices running in the cloud](https://learn.liferay.com/w/dxp/building-applications/client-extensions/microservice-client-extensions). Your code and resources don't rely on any of Liferay's code, and you can focus on whatever you're trying to create.
