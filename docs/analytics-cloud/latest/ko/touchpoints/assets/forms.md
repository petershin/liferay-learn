...
**제출:** 알려지거나 익명인 총 고유 방문자의 백분율을 나타내는 도넛형 차트입니다. 센터에는 순 방문자의 총 수가 표시됩니다. 도구 설명에는 해당 섹션의 사용자 수(예: 알려진 사용자 또는 익명 사용자 수)가 표시됩니다.
...
기본 탭에서 운영 체제(장치 유형별로 그룹화)별로 페이지 제출의 누적 막대 그래프를 봅니다.
