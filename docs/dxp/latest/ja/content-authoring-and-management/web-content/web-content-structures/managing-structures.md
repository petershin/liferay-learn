...
1. ［**ストラクチャー**］ タブを選択します。
1. ストラクチャーの横にある **アクションメニュー**（![Action Menu](../../../images/icon-actions.png)）を開き、 [使用可能なアクション](#available-actions) の1つを選択します。
...
1. ［**Copy**］ を選択します。
1. ストラクチャーの **名前** を入力し、オプションで新しい **説明** を入力します。
1. ストラクチャーに関連付けられたWebコンテンツテンプレートをコピーする場合は、オプションで ［**Copy Templates**］ ボックスをオンにします。
1. ［**Copy**］ をクリックします。
