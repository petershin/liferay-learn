...
**** 特定のユーザーが特定の [ユーザーセグメント](../../../../site-building/personalizing-site-experience/segmentation/creating-and-managing-user-segments.md)に属している場合、 [特定のカテゴリ](../../../../content-authoring-and-management/tags-and-categories/defining-categories-and-vocabularies-for-content.md) の検索結果をブーストします。
