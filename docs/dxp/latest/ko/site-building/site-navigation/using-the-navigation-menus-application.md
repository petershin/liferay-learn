...
1. _사이트 메뉴_ (![Site Menu](../../images/icon-product-menu.png))을 열고 _사이트 빌더_ &rarr; _탐색 메뉴_로 이동합니다.

    ![사이트 메뉴에서 탐색 메뉴에 액세스합니다.](./using-the-navigation-menus-application/images/02.png)

1. _추가_ 버튼(![Add Button](../../images/icon-add.png))을 클릭합니다.

1. 탐색 메뉴에 _이름_ 을 입력합니다.
...
1. _작업_ 버튼(![Actions](../../images/icon-actions.png))을 클릭합니다.
...
1. 원하는 탐색 유형을 선택합니다. _기본 탐색_, _보조 탐색_또는 _소셜 탐색_.

    ![원하는 탐색 유형을 선택합니다.](./using-the-navigation-menus-application/images/12.png)

    선택하면 각 메뉴의 구성이 _Marked As_ 열에 나타납니다.
...
1. 원하는 탐색 메뉴(예: _새 메뉴_) 옆에 있는 _작업_ 버튼(![Actions Button](../../images/icon-actions.png))을 클릭한 다음 _삭제_를 클릭합니다.
1. 확인에서 _확인_ 을 클릭합니다.
