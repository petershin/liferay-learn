...
出版物にページの編集が含まれている場合、元のバージョンのページと一緒にその変更をプレビューすることができます。 そのためには、変更点を確認しながら編集したページをクリックします。

![表示]タブでページのバージョンを表示します。](./making-and-publishing-changes/images/07.png)

選択後、各ページのバージョンを個別に表示したり、スプリットビューを選択して両方のバージョンを並べて表示したりすることができます。

![各ページのバージョンを個別に表示したり、スプリットビューを選択して並べて表示したりすることができます。](./making-and-publishing-changes/images/08.png)
...
1. ［**Publish**］ をクリックします。
   ...
   ![目的の出版物に移動し、「出版」をクリックします。](./making-and-publishing-changes/images/09.png)
