...
구성을 저장하기 전에 **테스트 구성** 클릭하여 Liferay가 txtai 서버와 연결할 수 있고 설정이 올바른지 확인하십시오.
...
1. Liferay에서 **글로벌 메뉴**(![Global Menu](../../../../images/icon-applications-menu.png)) &rarr; **제어판** &rarr; **검색 경험** &rarr; **시맨틱 검색** 엽니다.
   ...
   텍스트 임베딩 공급자로 **Hugging Face Inference API** 선택하고 복사한 액세스 토큰을 입력합니다.
...
구성을 저장하기 전에 **Test Configuration** 버튼을 클릭하여 Liferay가 Hugging Face Inference API와 연결할 수 있고 설정이 올바른지 확인하십시오.
...
1. Liferay에서 **글로벌 메뉴**(![Global Menu](../../../../images/icon-applications-menu.png)) &rarr; **제어판** &rarr; **검색 경험** &rarr; **시맨틱 검색** 엽니다.
   ...
   텍스트 포함 공급자로 **Hugging Face Inference Endpoints** 을 선택하고 복사한 액세스 토큰을 입력합니다.
...
구성을 저장하기 전에 **Test Configuration** 버튼을 클릭하여 Liferay가 Hugging Face Inference Endpoint와 연결할 수 있고 설정이 올바른지 확인하십시오.
