...
Control document access by [setting specific permissions](./managing-document-access/permissions-and-documents.md). Define who can view, edit, delete, or share each document to maintain tight security over your documents. Refer to the [documents and media permissions reference](./managing-document-access/documents-and-media-permissions-reference.md) for detailed information on permissions.
