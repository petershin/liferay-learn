...
1. Click the *Add Folder* button (![Add Folder Button](../../../images/icon-plus.png)).
...
This creates an empty folder with an autogenerated ERC. If desired, you can update the ERC by clicking the Actions button (![Actions Button](../../../images/icon-actions.png)) for the folder and selecting *Edit Label and ERC*.
...
1. Click the *Actions* button (![Actions Button](../../../images/icon-actions.png)) and select *Delete*.
