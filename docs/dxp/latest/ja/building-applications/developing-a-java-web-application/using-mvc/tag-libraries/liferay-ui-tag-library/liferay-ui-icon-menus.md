...
アイコンを正しくレンダリングするには、`url`属性が必要であることに注意してください。 属性の完全なリストについては、 [Icon Menu taglibdocs](https://resources.learn.liferay.com/reference/latest/en/dxp/taglibs/util-taglib/liferay-ui/icon-menu.html) を参照してください。
