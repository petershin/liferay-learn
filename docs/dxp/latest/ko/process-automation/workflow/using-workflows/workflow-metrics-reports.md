...
**양수인의 성과:** 각 워크플로 양수인의 평균 완료 시간 및 완료된 총 작업을 확인합니다. 워크플로 단계별로 이 메트릭을 필터링하면 담당자의 병목 현상이 있는 위치를 세밀하게 확인할 수 있습니다.
...
**프로세스**단계: 워크플로우에서 항목이 있는 위치를 식별합니다.
...
![워크플로 프로세스의 전체 흐름에서 항목이 있는 위치를 확인합니다.](./workflow-metrics-reports/images/15.png)
...
워크플로 정의에 있는 위치를 기준으로 항목을 필터링합니다. 예를 들어 단일 승인자 워크플로 프로세스에서 검토 작업의 모든 항목을 포함하는 보고서를 보도록 선택할 수 있습니다. 이는 워크플로 정의마다 다릅니다.
