...
**アカウントマネージャー：** アカウントマネージャーロールは、組織ロールとメンバーシップを持つすべてのユーザーが組織に関連付けられた **すべての** アカウントを管理できるユニークな組織ロールです。アカウント管理者のメンバーシップやロールを削除する権限を含め、それがアクセス権を持つアカウントの **すべての** 側面を管理する権限を付与します。アカウントマネージャーは、他のユーザーをアカウント管理者またはアカウントマネージャーとして割り当てることが **できます** 。
