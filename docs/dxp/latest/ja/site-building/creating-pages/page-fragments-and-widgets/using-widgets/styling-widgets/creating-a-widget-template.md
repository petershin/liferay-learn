...
*また、アプリのサイト別表示テンプレートを管理することもできます。 *表示テンプレート* ドロップダウンメニューの横にある「 [SPECIFIC_SITE]* の表示テンプレートを管理する」リンクをクリックして、これを行います。 設定されたテンプレートのリストが表示され、新しいテンプレートを追加したり、既存のテンプレートを編集したりすることができます。
