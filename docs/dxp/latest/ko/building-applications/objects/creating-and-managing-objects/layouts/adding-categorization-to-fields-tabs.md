...
1. *레이아웃* 탭으로 이동하여 원하는 레이아웃을 선택합니다.

   ![레이아웃 탭으로 이동하여 원하는 레이아웃을 선택합니다.](./adding-categorization-to-fields-tabs/images/01.png)

1. *Layout* 탭으로 이동하여 원하는 [Fields 탭](./designing-object-layouts.md#fields-tabs)에 대해 *Actions* 버튼(![Actions Button](../../../../images/icon-actions.png))을 클릭하고 *Add Categorization*을 선택합니다.
...
이제 사용자는 개체 항목을 생성하거나 편집할 때 태그 및 범주에 액세스하고 적용할 수 있습니다.
...
* [개체 보기 디자인](../views/designing-object-views.md)
