...
| インポート           | Wikiページを`.lar`ファイルとしてインポートする権限をユーザーに付与します（ [Wikiのエクスポートとインポート (近日公開！)](./exporting-and-importing-a-wiki.md) を参照）。 |
...
| 権限の設定             | ［**Wiki**］ ウィジェットの権限を表示する機能をユーザーに付与します         |
