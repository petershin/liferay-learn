...
In the Commerce context, notifications are supported for Channel events. See [Sending Emails](https://learn.liferay.com/commerce/latest/en/store-management/sending-emails) to learn more.
