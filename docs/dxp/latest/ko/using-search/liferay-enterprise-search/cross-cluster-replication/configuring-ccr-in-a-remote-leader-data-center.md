...
1. `elasticsearch.yml`을 구성합니다.
   ...
   보안 설정(`xpack.security...`)을 사용하려면 비밀번호를 설정하고 노드 인증서를 얻어야 합니다. 자세한 내용은 [Elasticsearch 보안](../../installing-and-upgrading-a-search-engine/elasticsearch/securing-elasticsearch.md) 을 참조하십시오.
