...
管理者は、Liferay Cloud Consoleを使って、各プロジェクト環境のチームメンバーやロールを管理することができます。 各環境には固有のメンバーが存在し、各メンバーは異なる環境で異なるロールを持つことができます。
...
新規のLiferay Cloudユーザーはアカウントを作成する必要がありますが、復帰したユーザーはLiferay Cloudの認証情報を使って **ログイン** することができます。
...
ロールは、環境内でのユーザーのアクセスレベルを決定します。 Liferay Cloudには、3つのデフォルトユーザーロールが用意されています。管理者、貢献者、およびゲストです。

**管理者** ： 管理者は、Liferay Cloud環境とそのメンバーを完全にコントロールできます。 以下の権限は、管理者のみに属するものです。
