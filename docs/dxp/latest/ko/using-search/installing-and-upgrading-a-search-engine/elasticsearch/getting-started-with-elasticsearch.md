...
> **호환성:** 호환 가능한 Elasticsearch 버전, 사용 가능한 Liferay 커넥터 및 필수 Liferay 패치 수준에 대한 자세한 내용은 [검색 엔진 호환성 매트릭스](https://help.liferay.com/hc/ko/articles/360016511651) 을 참조하십시오.
...
```{tip}
[라이프레이 엔터프라이즈 검색](../../liferay-enterprise-search.md) 구독을 통해 추가 기능 및 통합을 사용할 수 있습니다.
```
...
[검색 엔진 호환성 매트릭스](https://help.liferay.com/hc/ko/articles/360016511651) 은 각 Liferay 버전에 대해 지원되는 최신 Elasticsearch 구성 요소 버전을 보여줍니다. Elasticsearch 서버와 Elasticsearch에 대한 커넥터는 필수 구성 요소입니다.
