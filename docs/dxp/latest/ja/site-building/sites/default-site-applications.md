...
| [ダイナミック・データ・リスト](../../process-automation/forms/dynamic-data-lists.md) (**非推奨**)    | 定義されたフィールドセットを使用してフォームを作成・表示します。                 |
...
| [Wikiノード](../../collaboration-and-social/wiki.md)                                    | サイトのウィキ・ノードと記事の作成と管理。                            |
