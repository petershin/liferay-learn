...
1. 類似結果ウィジェットのオプションメニュー(![Options](../../images/icon-app-options.png)）を開き、 ［**設定**］ をクリックします。
...
**詳細設定** セクションでは、ウィジェットの動作を微調整するための設定を収集します。 これらの設定の多くは、 [ Elasticsearchのその他の類似結果](https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl-mlt-query.html) を設定するために使用されています。
