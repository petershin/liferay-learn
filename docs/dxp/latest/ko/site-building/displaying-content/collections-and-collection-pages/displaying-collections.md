...
1. 컬렉션 탭에서 컬렉션 중 하나를 선택하거나 **추가**( ![아이콘 추가](../../../images/icon-add.png) )를 클릭하여 [새 컬렉션을 만듭니다](../../../site-building/displaying-content/collections-and-collection-pages/creating-collections.md) .
...
1. 조각 탭의 콘텐츠 표시 범주 아래에서 **컬렉션 표시** 조각을 페이지의 한 사이트
로 드래그합니다.
...
**세로 정렬** : 항목 정렬 방법을 선택합니다(각 행의 위쪽, 중간, 아래쪽). 이 옵션은 **그리드** 스타일(버전 7.4 GA23+ 또는 U23+)을 선택한 경우에만 나타납니다.
...
1. 상위 자산 게시자의 경우 옵션( ![옵션](../../../images/icon-app-options.png) ) &rarr; **구성** 을 클릭합니다.
...
1. 하단 자산 게시자의 경우 옵션(![옵션](../../../images/icon-app-options.png)) &rarr; **구성** 을 클릭합니다.
...
1. **우주 프로그램 이미지** 를 클릭하거나 우주 프로그램 이미지 옆에 있는 ![옵션](../../../images/icon-options.png) &rarr; **편집** 을 선택하세요.
