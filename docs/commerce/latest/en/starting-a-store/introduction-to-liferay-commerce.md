...
Want to get started fast? Launch Liferay Commerce _fast_ [using the Liferay Commerce Docker image](../installation-and-upgrades/installing-commerce-2-1-and-below/using-the-liferay-commerce-docker-image.md).
...
[Channels](../store-management/channels.md) connect catalogs and products to any place products are sold: a Liferay Commerce based storefront, third party marketplaces, or even back office phone sales.
...
Liferay Commerce is optimized for business-to-business transactions with features designed to address B2B needs. [Accounts](../users-and-accounts/account-management.md), [Account Groups](../users-and-accounts/account-management/creating-a-new-account-group.md), and [Account Roles](../users-and-accounts/account-management/account-roles.md) work together to ensure that customer needs are met with tailored experiences, self-service, and purchasing workflows.
