...
そのセグメントの既知の個人のリストを見るには、パネルの一番下にある_View Members_リンクをクリックします。 または、ページ上部の「_メンバーシップ_」タブをクリックしてください。
...
興味のあるトピックの全リストを見るには、パネルの一番下にある _View All Interests_ リンクをクリックしてください。 または、ページ上部の「興味」タブをクリックしてください。
...
このパネルには最大で10種類の属性が表示されます。 ブレイクダウンのリストを見るには、パネルの一番下にある_Explore Breakdown_リンクをクリックしてください。 または、ページ上部の_Distribution_タブをクリックしてください。
