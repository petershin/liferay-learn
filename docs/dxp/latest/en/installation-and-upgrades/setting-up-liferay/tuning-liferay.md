...
Liferay uses HikariCP for connection pooling. The database connection is configured with [Portal Properties](../reference/portal-properties.md) under the [JDBC section](https://learn.liferay.com/reference/latest/en/dxp/propertiesdoc/portal.properties.html#JDBC). 
