...
[양식 구성 요소 조각](../../creating-pages/page-fragments-and-widgets/using-fragments/default-fragments-reference.md)은 콘텐츠 페이지에서 개체의 양식을 구축하기 위한 것입니다. Liferay의 양식 조각이 귀하의 사용 사례를 만족시키지 못하는 경우 양식에 대해 원하는 디자인과 기능을 달성하기 위해 직접 작성하십시오.
...
이제 양식 조각을 사용하여 콘텐츠 페이지에 양식을 작성하세요. 자세한 내용은 [조각을 사용하여 양식 작성](../../../building-applications/objects/using-fragments-to-build-forms.md)을 참조하세요.
...
이후에는 기본 Fragment를 생성할 때와 동일한 과정을 따릅니다. 기본 조각 생성 및 배포에 대한 자세한 내용은 [조각 툴킷 사용](./using-the-fragments-toolkit.md)을 참조하세요.
...
| `selectFromDocumentLibrary`    | `boolean`               | 사용자가 문서 라이브러리에서 파일을 선택할 수 있는지 여부입니다. 이는 객체의 [첨부 파일 필드](../../../building-applications/objects/creating-and-managing-objects/fields.md)에서 설정됩니다. |
