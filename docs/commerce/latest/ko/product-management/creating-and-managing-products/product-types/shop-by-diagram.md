...
*SKU에 연결됨*, 다이어그램에</em>*또는 카탈로그에 연결되지 않음* 또는 *를 선택합니다.<ul><li>SKU에 연결 - 다이어그램의 핀을 카탈로그의 SKU에 연결합니다.</li><li>다이어그램에 연결 - 다이어그램의 핀을 카탈로그의 다른 다이어그램에 연결합니다.</li><li>카탈로그에 연결되지 않음 - 다이어그램의 핀을 레이블에 연결합니다. 판매자는 정보 제공 목적으로 온라인 카탈로그에서 판매하지 않는 부품 또는 구성 요소의 이름을 다이어그램에 표시할 수 있습니다. 이 제품은 라벨을 사용합니다.</li></ul></td> </tr> 
...
1. 검색 창에서 SKU 또는 다이어그램을 검색하고 수량을 설정한 다음 대화 상자에서 위치를 할당합니다.
1. *저장*을 클릭합니다.
...
오른쪽에서 위치 및 수량과 함께 SKU를 볼 수 있습니다. 제품을 게시한 후 스토어프론트에서 볼 수 있습니다.
