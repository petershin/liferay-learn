...
1. _추가_ 버튼(![Add](../../../../images/icon-add.png))을 클릭합니다. 새 메타데이터 세트 양식이 나타납니다.
1. 이름을 입력하세요.
1. _세부 정보_ 섹션을 확장합니다.
1. 새 메타데이터 세트에 대한 설명을 입력합니다.
1. 상위인 경우 **상위 메타데이터** 필드를 비워 둡니다. 확장할 메타데이터 세트를 선택하려면 _상위 메타데이터 세트 _에 대해_ 선택* 을 클릭한 다음 원하는 메타데이터 세트를 선택합니다.
...
1. _번역 추가_을 클릭합니다.
1. 언어를 클릭합니다(예: _프랑스어(프랑스)_). 다른 로케일을 추가하려면 반복합니다.
