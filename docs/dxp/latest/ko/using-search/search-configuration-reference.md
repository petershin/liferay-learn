...
이 항목에는 하나의 반복 가능한 속성이 있습니다( [OSGi 구성 파일](../../system-administration/configuring-liferay/configuration-files-and-factories/using-configuration-files.md)를 통해 정의하는 경우 배열 구문 사용).
...
Liferay Enterprise Search 구독으로 사용할 수 있는 Liferay Enterprise Search 모니터링 모듈을 배포한 경우 Elasticsearch 모니터링 구성을 사용할 수 있습니다. 이러한 구성 속성은 전용 [모니터링 Elasticsearch](./liferay-enterprise-search/monitoring-elasticsearch.md) 설명서에서 다룹니다.
