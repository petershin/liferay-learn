...
1. **속성** 영역에서 그룹과 속성을 선택하여 세그먼트를 정의하세요. **속성** 을 **조건** 영역으로 끌어서 놓습니다.
...
- **속성**(C)을 끌어서 놓아 다른 **속성** 그룹을 사용하여 조건을 추가합니다.
...
편집할 때 기준을 충족하는 구성원 수가 조건 영역 상단에 나타납니다. **회원보기** 를 클릭하시면 목록을 보실 수 있습니다. 이는 세그먼트를 올바르게 정의하고 있는지 확인하는 데 도움이 됩니다.
