...
**What Changed**: The `HookHotDeployListener` class no longer supports deploying an exteneral repository via hook. Instead, convert your own external repository implementation into an OSGi service.
...
**Reason**: The method is not needed because any unscheduled job should be deleted at the same time.
...
[`modules/apps/commerce/commerce-api/src/main/java/com/liferay/commerce/service/CommerceShipmentItemLocalService.java`](https://github.com/liferay/liferay-portal/blob/master/modules/apps/commerce/commerce-api/src/main/java/com/liferay/commerce/service/CommerceShipmentItemLocalService.jav
* **Date**: Oct. 6, 2023
