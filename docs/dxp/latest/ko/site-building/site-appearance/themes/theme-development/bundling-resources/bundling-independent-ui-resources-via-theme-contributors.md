...
다음으로 사용자 지정 CSS 변경 사항으로 테마 기여자가 어떻게 보이는지 알아봅니다.
...
1. 프로젝트에서 `src/main/resources/META-INF/resources/css/custom.css` 엽니다.
...
축하해요! CSS 스타일 변경으로 테마 기여자를 만들었습니다. [Style Books](../../../style-books/using-a-style-book-to-standardize-site-appearance.md)을 사용하여 사이트 페이지에 특정 스타일 변경 사항을 적용할 수도 있습니다.
