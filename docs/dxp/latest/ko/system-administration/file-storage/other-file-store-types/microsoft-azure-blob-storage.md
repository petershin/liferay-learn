...
* [제어판을 통한 파일 저장 방법 구성](#configuring-the-store)
* [`dl.store.impl` 포털 속성을 Azure Blob Storage를 사용하도록 설정](#setting-azure-blob-storage-as-default-store) 를 기본 스토리지 방법으로 설정
...
1. Azure Blob 저장소 저장소에 대해 [연결 문자열](https://docs.microsoft.com/en-us/azure/storage/common/storage-configure-connection-string) 입력합니다.
...
1. 필요에 따라 파일 저장을 위해 [암호화 범위](https://docs.microsoft.com/en-us/azure/storage/blobs/encryption-scope-overview) 입력합니다.
...
## Azure Blob 저장소를 기본 저장소로 설정

Azure Blob Storage를 Liferay 인스턴스의 기본 저장소로 사용하려면 다음 단계를 따르세요.
