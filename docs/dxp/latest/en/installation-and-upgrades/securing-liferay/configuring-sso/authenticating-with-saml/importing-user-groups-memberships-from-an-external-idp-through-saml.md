...
!!! important
    ...
    If you assign users to other user groups in Liferay after signing in, these memberships are overwritten the next time you log in through the IdP. For user permissions, you should use [LDAP](../../../../users-and-permissions/connecting-to-a-user-directory/connecting-to-an-ldap-directory.md) or [SCIM](../../system-for-cross-domain-identity-management-scim.md) to manage memberships.
