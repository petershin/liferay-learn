...
1. Click the Options icon (![Click on the options icon to add a custom field.](../../images/icon-options.png)) for a Role and click Edit.
    ...
    ![The custom field is not visible in the resource UI.](adding-custom-fields/images/03.png)
...
![Clicking on the options icon gives you different choices.](adding-custom-fields/images/04.png)
