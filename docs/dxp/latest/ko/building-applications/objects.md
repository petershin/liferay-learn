...
개체를 생성할 때 데이터 [필드](./objects/creating-and-managing-objects/fields.md)를 정의하고 다른 개체 항목에 관계 [를 추가](./objects/creating-and-managing-objects/relationships.md) </a> 트리거수 있습니다. 항목 작성 중 및 개체의 응용 프로그램 페이지에서 필드 및 관계가 표시되는 방식을 결정하기 위해 [레이아웃](./objects/creating-and-managing-objects/layouts.md) 및 [보기](./objects/creating-and-managing-objects/views.md) 를 디자인할 수도 있습니다.</p> 
...
항목이 생성되면 Liferay의 정보 프레임워크를 활용하여 동적 사용자 경험을 생성할 수 있습니다. [페이지 조각 및 디스플레이 페이지 템플릿과 함께 객체 항목](./objects/displaying-object-entries.md) 표시. Liferay DXP 7.4</a> 및 Liferay Portal 7.4 부터 사이트 페이지에 개체를 위젯으로 배포할 수도 있습니다.</p> 
