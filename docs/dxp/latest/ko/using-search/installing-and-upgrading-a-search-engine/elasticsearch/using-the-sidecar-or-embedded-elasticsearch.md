...
1. 포털은 선택한 앱 서버</a> (예: Tomcat)에서 시작 에서 Elasticsearch 런타임을 다운로드하고 추출합니다.</p></li> </ol>
