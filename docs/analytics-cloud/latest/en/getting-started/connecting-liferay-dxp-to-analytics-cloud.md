...
1. Under _Platform_, click _Analytics Cloud_.
   ...
   You see a 4-step onboarding guide the first time you do this.
...
1. Select an existing Analytics Cloud property or click the _Add_ button (![Add Button](../images/icon-add.png)) to create one. Once selected, click _Assign_.
...
1. Log in to Analytics Cloud and select your workspace.
   ...
   ![You see an onboarding guide when you login first.](./connecting-liferay-dxp-to-analytics-cloud/images/08.png)
