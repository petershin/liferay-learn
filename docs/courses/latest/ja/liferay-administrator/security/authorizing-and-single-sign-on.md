...
Liferayは、レガシーシステム用のトークンベース、Open AM、CAS、OpenID Connect、Kerberos、Security Assertion Markup Language (SAML)など、シングルサインオンのための多くのエンタープライズオプションを提供しています。 多くの組織がそうであるように、Delectable Bonsaiもすべてを使用しているわけではないので、ここではSAMLに焦点を当てる。 その他のオプションについては、 [ドキュメント](https://learn.liferay.com/w/dxp/installation-and-upgrades/securing-liferay/configuring-sso) をご覧ください。
