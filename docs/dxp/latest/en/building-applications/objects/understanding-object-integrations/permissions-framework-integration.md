...
| Object Entry History | Use REST APIs to [query entry history](../objects-tutorials/using-apis/using-nestedfields-to-audit-entry-history.md). This permission is only available while [Entry History is enabled](../creating-and-managing-objects/auditing-object-definition-events.md#enabling-entry-history) for the object definition. |
