...
| `LCP_BACKUP_RESTORE_SCHEDULE`                   | N/A                        | 이 변수는 [cron 예약 구문](https://crontab.guru/) 을 사용하여 자동 복원을 예약합니다. [재해 복구 환경](../../troubleshooting/configuring-cross-region-disaster-recovery.md)과 함께 사용하기 위한 것입니다. |
