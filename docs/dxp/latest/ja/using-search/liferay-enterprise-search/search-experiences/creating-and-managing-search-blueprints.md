...
- 7.4 U52+の場合、 **View Raw Request** をクリックすると、検索リクエストの文字列全体が表示されます。 Raw Requestモーダルから、リクエストをクリップボードにコピーするか、JSONファイルとしてダウンロードすることができます。 これは、検索ページの [検索インサイト](../../search-pages-and-widgets/search-insights.md) ウィジェットで見られるリクエストと同じです。

- ［**View Raw Response**］ をクリックすると、検索応答文字列全体を表示します。 Raw Responseモーダルから、レスポンスをクリップボードにコピーするか、JSONファイルとしてダウンロードすることができます。 これは、検索ページの [検索インサイト](../../search-pages-and-widgets/search-insights.md) ウィジェットで見ることができる文字列と同じです。
