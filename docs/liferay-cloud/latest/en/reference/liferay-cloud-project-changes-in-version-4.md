...
The `liferay` service folder now follows the functional structure of a [Liferay Workspace](https://learn.liferay.com/w/dxp/developing-applications/tooling/liferay-workspace/what-is-liferay-workspace).
