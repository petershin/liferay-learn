...
1. **제안** 섹션(![제안](../../images/icon-comments-w.png))으로 이동합니다.
...
```
각 제안은 관련 기사에 대한 링크, 피드백, 사용자 이름, 피드백 타임스탬프 및 제안 해결 상태를 제공합니다. 각 항목의 작업 메뉴(![작업 아이콘](../../images/icon-actions.png))를 사용하여 항목을 **신규** , **진행 중** 및 **해결됨** 상태 간에 이동할 수 있습니다.

개별 제안을 클릭하고 표시하여 진행 상황을 진행할 수도 있습니다.

![Track the progress of suggestions.](./responding-to-knowledge-base-feedback/images/02.png)

피드백에는 먼저 진행 중으로 이동 버튼이 표시된 다음 해결 버튼이 표시됩니다. **새로 만들기** 버튼을 클릭하면 제안을 새 상태로 다시 변경할 수 있습니다. **삭제** 버튼을 클릭하여 제안 사항을 삭제할 수도 있습니다.
