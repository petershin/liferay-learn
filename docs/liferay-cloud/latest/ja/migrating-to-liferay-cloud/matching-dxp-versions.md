...
1. [パッチングツールのインストール](https://learn.liferay.com/dxp/latest/ja/installation-and-upgrades/maintaining-a-liferay-installation/reference/installing-the-patching-tool.html) の手順に従って、移行したいインストールにパッチングツールをインストールします。
