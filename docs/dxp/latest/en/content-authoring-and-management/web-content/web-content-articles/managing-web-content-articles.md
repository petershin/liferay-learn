...
Once you've added articles to your web content library, you can manage them via the web content UI. To access management actions for an article, click it's *Actions* button (![Actions button](../../../images/icon-actions.png)).

![Click the article's actions button to access configuration options.](./managing-web-content-articles/images/01.png)

| Option                                                                | Description                                                                                                                                                                                                                                              |
|:----------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Edit (![Edit](../../../images/icon-edit.png))                         | Edit the articles content. Note that modifying the article will increase its version number.                                                                                                                                                             |
...
| View History (![View History](../../../images/icon-date-time.png))    | View web content versions history.                                                                                                                                                                                                                       |
...
| Permissions (![Permissions](../../../images/icon-permissions.png))    | Manage articles permissions for user roles.                                                                                                                                                                                                              |
...
In the info panel, the article's information is organized into two tabs: Details and Versions. To access the info panel of an article, select the article and click the toogle info panel (![Toogle info panel](../../../images/icon-information.png)) on the Applications Menu.
...
| Make a Copy (![Copy](../../../images/icon-copy.png))   | Creates a new web content article thunarwith the version selected. The copy uses the same name with "Copy" appended to the end.                                                    |
