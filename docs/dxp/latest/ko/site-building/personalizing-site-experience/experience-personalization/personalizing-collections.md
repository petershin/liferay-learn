...
1. **사이트 메뉴**( ![사이트 메뉴](../../../images/icon-applications-menu.png) )를 열고 **사이트 빌더** &rarr; **컬렉션** 으로 이동합니다.

1. [컬렉션](../../../site-building/displaying-content/collections-and-collection-pages/creating-collections.md) 생성하거나 기존 컬렉션을 선택하세요.

1. **맞춤 변형 추가** 를 클릭하세요.

   이미 개인화된 변형이 있고 사용 가능한 다른 세그먼트가 있는 경우 **추가**(![추가 아이콘](../../../images/icon-add-app.png)를 클릭하여 새로운 개인화된 변형을 추가하세요. )) 맞춤 변형 옆에 있습니다.
...
컬렉션을 편집할 때 개인화된 변형에 대한 정렬 가능한 목록에 액세스하고 해당 **작업** 버튼( ![작업 버튼](../../../images/icon-actions.png)을 클릭하여 변형 순위를 변경합니다. ) )**우선순위** 또는 **우선순위 해제** 를 선택합니다. 대안을 끌어서 놓아 우선순위를 재정렬할 수도 있습니다.
...
1. **글로벌 메뉴**( ![응용 프로그램 메뉴 아이콘](../../../images/icon-applications-menu.png) )를 열고 구성에서 **제어판** 탭 &rarr; **시스템 설정** 을 선택합니다.

1. 콘텐츠 및 데이터에서 **자산** 을 선택합니다.

1. 시스템 범위에서 **컬렉션** 을 선택합니다.
...
1. **사이트 메뉴**( ![사이트 메뉴](../../../images/icon-applications-menu.png) )를 열고 **콘텐츠 및 데이터** &rarr; **콘텐츠 세트** 로 이동합니다.

1. **추가**( ![추가](../../../images/icon-add.png) )를 클릭하고 **수동 선택** 을 선택합니다.

1. 이름을 **홈 페이지 콘텐츠** 로 지정합니다.

1. 새 콘텐츠 세트의 경우 자산 항목 옆에 있는 **선택** 을 클릭하고 **기본 웹 콘텐츠** 를 선택합니다.

   ![Click Select to add a new asset entry.](./personalizing-collections/images/05.png)

1. 기본 웹 콘텐츠 선택 페이지에서 추가하려는 콘텐츠를 선택하고 **추가** 를 클릭하세요.
...
1. 콘텐츠 세트 선택에서 **선택** 을 클릭하고 **홈 페이지 콘텐츠** 를 선택한 다음 **저장** 을 클릭합니다.
...
1. **New Personalized Variation** 을 클릭하고 American Engineers 세그먼트를 선택하세요.

   ![Create a new personalized variation.](./personalizing-collections/images/06.png)

1. 자산 항목 옆에 있는 **선택** 을 클릭하고 **기본 웹 콘텐츠** 를 선택하세요.

1. 엔지니어링 독자에게 적합한 기사를 선택하고 **추가** 를 클릭하세요.
