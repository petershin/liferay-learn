...
| Custom User Atribute (in the Asset Publisher widget) | Bundled | Replaced by [Collections and Experiences](../../../site-building/displaying-content/using-the-asset-publisher-widget/displaying-assets-using-the-asset-publisher-widget.md#displaying-content-dinamically-using-experiences). |
