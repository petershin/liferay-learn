...
| 機能                                | 利用可能                    | メモ                                                                                                                                                                                                                                                    |
|:--------------------------------- |:----------------------- |:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| App Builder, App Builderワークフロー    | 削除しました                  | [Liferay Objects](../../../building-applications/objects.md)によって置き換えられました。                                                                                                                                                                            |
| Bootstrap 3 & Bootstrap 4 互換性レイヤー | 削除しました                  | [Theme upgrade](../../../site-building/site-appearance/themes/upgrading-a-theme.md)時に互換性レイヤーを追加することを選択するか、手動でレイヤーを追加します。                                                                                                                              |
| コマースアカウントウィジェット                   | 削除しました                  | DXP/Portalアカウントウィジェットに置き換わりました。                                                                                                                                                                                                                       |
| 中央認証サービス（CAS）                     | アーカイブ済み                 | 7.2で廃止。 SAML、OpenID Connect、Token-based SSOなど、他のソリューションに置き換えられています。                                                                                                                                                                                   |
| コマースカテゴリ・ナビゲーションウィジェット            | バンドル                    | [表示ページテンプレート](../../../site-building/displaying-content/using-display-page-templates/about-display-page-templates-and-display-pages.md) [メニュー表示](../../../site-building/site-navigation/configuring-menu-displays.md) 対応に置き換わりました。                    |
| コマースの素材リスト（BOM）について               | 削除しました                  | コマースBOMに置き換えられます。                                                                                                                                                                                                                                     |
| コマースカテゴリーコンテンツウィジェット              | バンドル                    | [ディスプレイページテンプレート](../../../site-building/displaying-content/using-display-page-templates/about-display-page-templates-and-display-pages.md)で置き換えられました。                                                                                                |
...
| アンケート                             | 削除しました                  | [Forms/Forms Reports](../../../process-automation/forms/sharing-forms-and-managing-submissions/form-reports.md)に置き換わりました。                                                                                                                             |
...
| Solrコネクター                         | 削除しました                  | 7.3で廃止。 Elasticsearchに置き換えられました。                                                                                                                                                                                                                      |
...
| 機能             | メモ                                                                              |
|:-------------- |:------------------------------------------------------------------------------- |
| エクスポート / インポート | [公開](../../../site-building/publishing-tools/publications.md)に置き換えられます。         |
| Kaleoフォーム      | [Liferay Objects](../../../building-applications/objects.md)のビジネスプロセスに置き換えられます。 |
| ステージング         | [公開](../../../site-building/publishing-tools/publications.md)に置き換えられます。         |
