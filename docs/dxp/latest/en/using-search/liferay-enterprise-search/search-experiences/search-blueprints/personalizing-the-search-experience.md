...
See [Elastic's Function Score Query](https://www.elastic.co/guide/en/elasticsearch/reference/8.13/query-dsl-function-score-query.html) documentation for more details.
