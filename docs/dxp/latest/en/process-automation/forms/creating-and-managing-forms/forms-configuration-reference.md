...
| [Liferay 7.4 Only] Submissions | Limit to One Submission per User | Require that only logged in users can fill out the form, and do not allow multiple form submissions. Users visiting the form after submitting see a warning message. As of Liferay U49+/GA49+, you can customize the message. |
