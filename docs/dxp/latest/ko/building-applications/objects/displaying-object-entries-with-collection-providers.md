...
{bdg-secondary}`라이프레이 7.4 U77+/GA77+`

객체 정의를 게시하면 Liferay는 이에 대한 [컬렉션 공급자](../../content-authoring-and-management/collections-and-collection-pages/collection-providers.md)를 생성합니다. [컬렉션 표시 조각](../../site-building/displaying-content/additional-content-display-options/displaying-collections.md#adding-a-collection-display-fragment-to-a-page) 및 [컬렉션 페이지](../../site-building/displaying-content/additional-content-display-options/displaying-collections.md#displaying-collections-on-a-collection-page)와 함께 이 공급자를 사용하여 해당 항목을 표시할 수 있습니다. 개체는 필터링, 스타일 지정, 표시 옵션을 포함한 모든 컬렉션 표시 기능을 지원합니다.

## 개체의 컬렉션 공급자 사용

1. 새 [콘텐츠 페이지](../../site-building/creating-pages/using-content-pages.md) 또는 [표시 페이지 템플릿](../../site-building/displaying-content) 을 만듭니다. /using-display-page-templates/creating-and-managing-display-page-templates.md). 또는 기존 항목 편집( ![Edit Button](../../images/icon-edit-pencil.png) )을 시작합니다.
...
컬렉션 표시 조각에 대한 개체를 선택하면 해당 개체가 매핑 소스로 설정됩니다. 이제 조각을 추가하고 해당 조각의 [sub-elements](../../site-building/creating-pages/page-fragments-and-widgets/using-fragments/configuring-fragments/fragment-sub-elements-reference) 을 매핑할 수 있습니다. md)를 개체 필드에 추가하여 개별 개체 항목에 대한 유연한 페이지 표시를 만듭니다. 컬렉션 페이지에도 마찬가지입니다.
...
```{important}
조각 요소를 관련 개체 필드에 매핑하는 것은 릴리스 기능 플래그 뒤에 있습니다. 자세한 내용은 [릴리스 기능 플래그](../../system-administration/configuring-liferay/feature-flags.md#release-feature-flags) 를 읽어보세요.
```

매핑된 객체가 [일대다 관계](./creating-and-managing-objects/relationships/defining-object-relationships.md)의 하위 측에 있는 경우 조각 요소를 상위 개체. 포함된 컬렉션 표시 조각은 고유한 [관련 항목 컬렉션 공급자](../../content-authoring-and-management/collections-and-collection-pages/collection-providers.md#관련-items-collections-providers를 사용합니다. ) 새 컬렉션을 구성합니다.
