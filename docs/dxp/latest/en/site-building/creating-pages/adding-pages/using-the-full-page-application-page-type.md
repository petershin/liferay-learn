...
1. Select the application you want to display from the list of applications under the Full Page Application heading. By default, you can set the Blogs, Wiki, Media Gallery, Message Boards, RSS Publisher, Documents and Media, Form, Multi-Factor Authentication, Application Authorization Request, or Multi-Factor Authentication Verify to be the sole application for the page. Developers can make their applications full page applications.
