...
로그인하면 [사이트 ID를 검색](../../../headless-delivery/consuming-apis/consuming-rest-services.md#identify-the-site-containing-the-data) 합니다. 여러 서비스 호출에서 이 ID를 사용합니다.
...
응답에는 파일의 설명, 새로 할당된 ID, 제목 등이 포함됩니다. 이후 명령에 대한 `id` 값을 기록해 둡니다.
