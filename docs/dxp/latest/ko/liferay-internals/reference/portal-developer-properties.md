...
| 콤보.체크.타임스탬프=참                                                 | 콤보 서블릿을 비활성화하여 디버깅을 용이하게 합니다. 자세한 내용은 [`combo.check.timestamp`](https://resources.learn.liferay.com/reference/latest/en/dxp/propertiesdoc/portal.properties.html) 정의를 참조하십시오. |
