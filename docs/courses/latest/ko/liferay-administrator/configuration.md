...
범위 또는 수준의 계층 구조에서 많은 설정을 구성할 수 있습니다. 보다 세부적인 범위 설정은 그 위의 설정보다 우선 적용됩니다. 예를 들어 사이트 수준의 구성 세트는 시스템 수준이나 인스턴스 수준의 구성보다 우선합니다. 이렇게 하면 범위(예: 인스턴스 또는 사이트) 소유자가 재정의할 수 있는 적절한 기본값을 설정할 수 있습니다. 자세한 내용은 구성 범위 이해 [구성 범위 이해](https://learn.liferay.com/dxp/latest/en/system-administration/configuring-liferay/understanding-configuration-scope.html) 참조하세요.
