...
When you limit submissions to one per user, you can also set the warning message's header and body content. Otherwise, the default message appears when the user views the form after submitting:
