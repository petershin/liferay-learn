...
```{important}
Kaleo Forms は Liferay 7.4 で [maintenance mode](../../installation-and-upgrades/upgrading-liferay/reference/maintenance-mode-and-deprecations-in-7-4.md) になっています。 可能であれば [Objects](../../../building-applications/objects.md) を使用してください。
```
