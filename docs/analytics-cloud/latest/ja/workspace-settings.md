...
[他のユーザーを招待し、ワークスペースへのアクセスを管理します。](./workspace-settings/managing-users.md) なお、 [多要素認証](./workspace-settings/multi-factor-authentication.md) 、ユーザーごとに必要です。

[ワークスペースにあるさまざまなプロパティ](./workspace-settings/managing-properties.md) を表示し、管理します。 また、 [プロパティを使用したスコープサイトと個人](./workspace-settings/scoping-sites-and-individuals-using-properties.md) および [コンタクトシンクのデータ参照](./workspace-settings/contact-sync-data-reference.md) も参照してください。
