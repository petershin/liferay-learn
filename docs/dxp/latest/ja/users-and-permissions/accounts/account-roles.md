...
1. [グループ スコープ権限の定義] タブをクリックします。 他のグループ (サイト、チャネル、アセット ライブラリなど) が所有するリソースに対してロールが実行する権限を選択します。 [現在のアカウントとして選択された](./account-management-widget.md#using-the-account-management-widget) アカウントに権限が適用されることに注意してください。
