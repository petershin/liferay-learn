...
카탈로그 및 제품을 관리하기 위해 새 사용자 정의 역할을 생성하거나 기존 역할을 수정하여 시작하십시오. 이 역할은 시스템 전체 기능에 대한 최소한의 액세스 권한을 갖도록 구성할 수 있습니다. 사용자 권한 정의에 대한 자세한 내용은 [역할 권한 정의](https://learn.liferay.com/dxp/latest/ko/users-and-permissions/roles-and-permissions/defining-role-permissions.html) 을 참조하십시오.
...
1. _저장_을 클릭합니다.
1. _권한 정의_을 클릭합니다.
1. _제어판_ &rarr; _상거래_ 를 클릭하여 드롭다운 메뉴를 확장합니다.
...
1. (![3-dot icon](../../images/icon-actions.png)) 을 클릭한 다음 _Permissions_를 클릭 하십시오 .
