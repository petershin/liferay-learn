...
1. 아래에 표시되는 **개의 확인란** 을 모두 클릭합니다. 버튼을 활성화하여 복원을 시작하려면 이 확인란을 선택해야 합니다.
...
1. [사용자 지정 SQL 스크립트를 온라인으로 포함하도록 백업 서비스](../../build-and-deploy/overview-of-the-liferay-cloud-deployment-workflow.md) 을 배포합니다.
