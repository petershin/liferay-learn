...
1. グローバルメニュー( [グローバルメニュー](../../../images/icon-applications-menu.png) )に移動します。 &rarr; **コントロールパネル** &rarr; **インスタンス設定** .
...
1. 左のナビゲーションで、 **Outlook Auth Connector** をクリックします。 クライアントID、クライアントシークレット、テナントIDを各入力ボックスに貼り付けます。
