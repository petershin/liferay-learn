...
1. Upon authentication, you are directed to the Analytics Cloud start page. From here, you can [Connect Liferay DXP to Analytics Cloud](../getting-started/connecting-liferay-dxp-to-analytics-cloud.md).
