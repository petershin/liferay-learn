...
Use Liferay's OAuth2 tools to authorize third-party applications to access data. For example, a Delectable Bonsai partner wants to sell products with up-to-date pricing. They request Delectable Bonsai to provide access to the price list API. Follow the steps below to see this in action.
