...
1. 왼쪽 탐색 메뉴에서 _메일 설정_을 클릭하세요. 다음 구성을 설정합니다.
...
1. 왼쪽 탐색에서 _Outlook 인증 커넥터_를 클릭합니다. 클라이언트 ID, 클라이언트 암호 및 테넌트 ID를 각 입력 상자에 붙여넣습니다.
...
1. _POP3 연결 활성화_ 및 _SMTP 연결 활성화_ 확인란을 선택합니다.
