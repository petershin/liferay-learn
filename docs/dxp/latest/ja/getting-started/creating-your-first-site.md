...
新しいサイトが作成され、 ［**Home**］ と ［**Wiki**］ の2つのページで使用できるようになります。 各ページには、すでにいくつかのアプリケーションが配置されているので、それを使い始めることができる。
...
Liferay Sitesは柔軟で強力であり、さまざまなニーズに合わせて構成することができます。 詳しくは、 [サイト構築を始める](../site-building/getting-started-with-site-building.md) をご覧ください。
