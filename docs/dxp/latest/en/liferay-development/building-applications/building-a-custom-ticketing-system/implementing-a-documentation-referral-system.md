...
The documentation referral system is a [microservice](../../integrating-microservices.md) type client extension. Specifically, this sample is a Spring Boot application that is built with `BootJar`. The `assemble` block section of the `client-extension.yaml` identifies this as follows:
...
See [Object Action Yaml Configuration](../../integrating-microservices/object-action-yaml-configuration-reference.md) for an explanation of each property.
