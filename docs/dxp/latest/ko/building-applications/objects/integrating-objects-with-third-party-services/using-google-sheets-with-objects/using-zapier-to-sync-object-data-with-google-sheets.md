...
1. *Trigger* 단계를 클릭하고 Zapier</em>의 *Webhooks를 선택합니다.</p>
...
*Trigger Event* 드롭다운 메뉴를 클릭하고 *Catch Hook*을 선택한 다음 *Continue*를 클릭합니다.
...
Zap을 켭니다.
   ...
   ![Zap을 켭니다.](./using-zapier-to-sync-object-data-with-google-sheets/images/14.png)</ol>
