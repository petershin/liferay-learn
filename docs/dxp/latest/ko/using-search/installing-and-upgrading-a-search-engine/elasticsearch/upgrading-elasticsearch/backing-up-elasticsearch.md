...
`<companyId>` (예: `20101`)는 데이터베이스의 지정된 `Company` 레코드에 속합니다. UI에서 _인스턴스 ID_ 로 표시되며 [가상 인스턴스](../../../../system-administration/configuring-liferay/virtual-instances/understanding-virtual-instances.md)나타냅니다.
