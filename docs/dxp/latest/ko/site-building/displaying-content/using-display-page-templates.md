...
-   [Categories](../../content-authoring-and-management/tags-and-categories/defining-categories-and-vocabularies-for-content.md) {bdg-secondary}`7.4 이상 사용 가능`
-   [사용자 지정 개체](../../building-applications/objects/displaying-object-entries.md) {bdg-secondary}`7.4 이상 사용 가능`
...
:::{grid-item-card} 디스플레이 페이지 템플릿 생성 및 관리
