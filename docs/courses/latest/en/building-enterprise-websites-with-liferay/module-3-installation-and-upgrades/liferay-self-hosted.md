...
At a high level:
* To install, download a Liferay Tomcat bundle. Set your `[Liferay_Home]` folder, configure your database, and start Liferay.
...
Extract the bundle to a location on your host machine. This location is called your [`Liferay_Home`](https://learn.liferay.com/web/guest/w/dxp/installation-and-upgrades/reference/liferay-home?p_l_back_url=https%3A%2F%2Flearn.liferay.com%2F).

### Run Liferay

Once you have installed and extracted the bundle, run Liferay.
...
1. Click *Finish Configuration*. Restart your server and Liferay is ready to use.

## Upgrades

Upgrading Liferay is as easy as downloading a new Tomcat bundle and matching your current settings. Follow the steps to perform an upgrade for Tomcat.
