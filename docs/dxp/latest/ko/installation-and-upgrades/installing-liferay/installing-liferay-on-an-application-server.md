...
1. 응용 프로그램 서버 중 하나인 DXP/Portal 설치 지침을 따르십시오.
    ...
    * [와일드플라이](./installing-liferay-on-an-application-server/installing-on-wildfly.md)
    * [제이보스 EAP](./installing-liferay-on-an-application-server/installing-on-jboss-eap.md)
    * [웹로직](./installing-liferay-on-an-application-server/installing-on-weblogic.md)
