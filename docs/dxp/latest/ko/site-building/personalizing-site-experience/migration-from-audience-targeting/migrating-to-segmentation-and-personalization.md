...
마지막으로 대상 대상 지정에서 행동 기반 기능을 마이그레이션해야 합니다. Liferay DXP 7.2+부터는 행동 기반 규칙이 Liferay Analytics Cloud를 사용하여 관리됩니다. 자세한 내용은 [세그먼트](https://learn.liferay.com/analytics-cloud/latest/ko/people/segments/segments.html) 참조하십시오.
