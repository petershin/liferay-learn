...
Liferay 7.2+부터 행동 기반 규칙은 Analytics Cloud를 사용하여 관리됩니다. 자세한 내용은 [Analytics Cloud 설명서](https://learn.liferay.com/analytics-cloud/latest/en/people/segments/segments.html) 참조하십시오.
