...
With [Master Page Templates](creating-pages/defining-headers-and-footers/master-page-templates.md), you can define common elements for your pages using Fragments, especially headers and footers. You can use them to conform any number of pages on your Site to the look and feel you design.
...
[Style Books](site-appearance/style-books/using-a-style-book-to-standardize-site-appearance.md) are sets of visual standards that apply to a Site, such as standard colors and spacing. With *Style Books*, you can design every page's layout independently while maintaining a consistent experience between each of them.
