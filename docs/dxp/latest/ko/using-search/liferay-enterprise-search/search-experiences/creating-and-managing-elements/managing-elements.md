...
기존 요소를 복제하려면 작업(![Actions](../../../../images/icon-actions.png)) 버튼을 클릭하고 **Copy** 를 선택합니다. 복제된 요소는 다른 사용자 지정 요소와 마찬가지로 삭제하거나 편집할 수 있습니다.

요소를 내보내려면 요소에 대한 작업(![Actions](../../../../images/icon-actions.png)) 버튼을 클릭하고 **내보내기** 를 선택합니다.

요소를 가져오려면 화면 상단 모서리(전역 메뉴 아이콘 옆)에 있는 작업(![Actions](../../../../images/icon-actions.png)) 버튼을 클릭합니다. **가져오기** 을 클릭하고 요소의 JSON 파일을 찾습니다.
