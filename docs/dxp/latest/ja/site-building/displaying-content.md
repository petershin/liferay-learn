...
様々な方法でコンテンツを表示することができます。 選択するオプションは、表示するアセットのタイプ、一度に表示するアセットの数、コンテンツの表示方法によって異なります。 Liferay でのコンテンツ表示について詳しくは、 [コンテンツの表示](./displaying-content/displaying-content-intro.md) をお読みください。

::::{grid} 2
:gutter: 3 3 3 3

:::{grid-item-card} コレクションの使用
:link:  ./displaying-content/using-collections.md
:::

:::{grid-item-card} アセットパブリッシャーウィジェットの使用
:link: ./displaying-content/using-the-asset-publisher-widget.md
:::

:::{grid-item-card} 表示ページテンプレートの使用
:link: ./displaying-content/using-display-page-templates.md
:::

:::{grid-item-card} コンテンツの表示の追加オプション
:link:  ./displaying-content/additional-content-display-options.md
:::

:::{grid-item-card} 情報テンプレートの使用
