...
[선택 목록](../../picklists.md)을 사용하면 문자열 목록을 정의하고 이를 개체 필드로 사용하여 항목에 대한 사용자 정의 상태를 정의할 수 있습니다. 객체 정의에 추가되면 각 상태에 대한 흐름을 디자인하고 [validations](../validations/adding-field-validations.md) 및 [actions](../actions/defining-object-actions.md)를 사용할 수 있습니다. md) 다양한 상태에 대한 비즈니스 로직을 추가합니다. 상태를 [워크플로 상태](../../enabling-workflows-for-objects.md)와 함께 사용하여 보다 복잡한 검토 및 승인 프로세스를 정의할 수도 있습니다.
...
1. 원하는 항목으로 선택 목록을 만듭니다. 이러한 항목은 개체 항목 상태를 정의합니다. 자세한 단계는 [선택 목록 만들기](../../picklists/creating-picklists.md)를 참조하세요.
...
정의에 필드를 추가한 후 [흐름을 설정](#setting-up-a-flow-for-state-fields) 하여 각 상태에 사용할 수 있는 전환을 결정할 수 있습니다.
