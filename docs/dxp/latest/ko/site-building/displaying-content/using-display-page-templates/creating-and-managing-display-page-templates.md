...
1. 템플릿에 *이름* 을 입력하고 해당하는 경우 *콘텐츠 유형* 및 *하위 유형*를 선택합니다. 그런 다음 *저장*을 클릭합니다.
...
애플리케이션 메뉴에서 *미리보기* 드롭다운 메뉴를 클릭하고 콘텐츠 항목을 선택할 수 있습니다. 항목이 나타나지 않으면 *기타 항목 선택* 을 클릭하고 원하는 콘텐츠를 찾습니다. 그러면 필드 매핑에 따라 콘텐츠 데이터로 템플릿이 동적으로 채워집니다.

![표시 페이지 템플릿을 미리 보는 데 사용할 콘텐츠를 선택합니다.](./creating-and-managing-display-page-templates/images/07.png) <!--TASK: UPDATE IMG FOR LRDOCS-10856-->

또는 디스플레이 페이지 템플릿 편집기에서 *미리보기* (![Preview](../../../images/icon-preview.png)) 버튼을 클릭하고 미리볼 콘텐츠를 선택합니다.

![표시 페이지 템플릿 매핑을 미리 보려면 미리보기 버튼을 클릭합니다.](./creating-and-managing-display-page-templates/images/08.png) <!--TASK: UPDATE IMG FOR LRDOCS-10856-->
...
1. *오른쪽 상단 모서리에 있는 작업* 메뉴(![Actions](../../../images/icon-actions.png))를 클릭하고 *기본값으로 지정* 또는 *지정 해제*을 선택합니다.
