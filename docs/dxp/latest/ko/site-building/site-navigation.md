...
Liferay DXP는 사이트의 탐색 메뉴를 페이지 계층 구조에서 분리하여 컨텐츠에 쉽게 액세스할 수 있는 강력한 도구와 함께 필요한 유연성을 제공합니다. 여기에서는 페이지 계층 구조 관리, 탐색 메뉴 애플리케이션 사용, 메뉴 표시 구성 등을 통해 콘텐츠에 액세스하고 쉽게 사용할 수 있도록 하는 방법을 배울 수 있습니다.
