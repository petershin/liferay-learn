...
Liferay는 **콘텐츠 페이지** 번역을 위한 통합 도구를 제공하므로 전 세계 사용자를 위한 매력적이고 현지화된 경험을 만들 수 있습니다. 이러한 도구를 사용하면 콘텐츠 페이지 경험을 수동으로 번역하거나 번역을 XLIFF 파일로 가져올 수 있습니다.
...
1. **사이트 메뉴**(![사이트 메뉴](../../images/icon-product-menu.png))를 열고 **사이트 빌더** 를 확장한 다음 **페이지** 로 이동합니다.

1. 번역하려는 콘텐츠 페이지에 대해 **작업** 버튼(![작업 버튼](../../images/icon-actions.png))을 클릭하고 **번역** 을 선택합니다.
...
1. 번역하려는 콘텐츠 페이지에 대해 **작업** 버튼(![작업 버튼](../../images/icon-actions.png))을 클릭하고 **번역을 위해 내보내기** 를 선택합니다. 내보내기를 구성하기 위한 모달 창이 열립니다.
...
1. 번역된 콘텐츠 페이지에 대해 **작업** 버튼(![작업 버튼](../../images/icon-actions.png))을 클릭하고 **번역 가져오기** 를 선택합니다.
