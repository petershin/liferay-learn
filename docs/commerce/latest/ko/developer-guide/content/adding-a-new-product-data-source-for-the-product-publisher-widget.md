...
제품 데이터 소스는 관련된 제품을 검색하는 고유한 방법을 제공합니다. Liferay Commerce는 제품 관계</a> 로 [, 카테고리](https://github.com/liferay/liferay-portal/blob/[$LIFERAY_LEARN_PORTAL_GIT_TAG$]/modules/apps/commerce/commerce-product-service/src/main/java/com/liferay/commerce/product/internal/data/source/CPDataSourceDefinitionLinkTypeImpl.java)으로
를 검색하는 제품을 포함하여 기본적으로 여러 제품 데이터 소스를 제공합니다.</p> 
