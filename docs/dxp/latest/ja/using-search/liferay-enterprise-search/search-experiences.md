...
Liferay Search Experiences は、Liferay DXP 7.3 では [Liferay Enterprise Search](../liferay-enterprise-search.md) サブスクリプションで、Liferay 7.4 では [Liferay DXP とバンドルされています](./activating-liferay-enterprise-search.md). 詳しくは、 [LES Compatibility Matrix](https://help.liferay.com/hc/en-us/articles/360016511651#DXP-7.3-LES) をご確認ください。
...
1. Liferay DXPにアプリケーションをインストールします。
   ...
   * Liferay Docker コンテナを実行している場合、 [サポートされているいずれかの方法で LPKG をインストールします](../../installation-and-upgrades/installing-liferay/using-liferay-docker-images/installing-apps-and-other-artifacts-to-containers.md).
