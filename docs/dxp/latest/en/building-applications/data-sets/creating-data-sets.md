...
!!! important
   This feature is currently behind a [developer feature flag](../../system-administration/configuring-liferay/feature-flags.md#dev-feature-flags) (LPS-167253) and a [release feature flag](../../system-administration/configuring-liferay/feature-flags.md#release-feature-flags) (LPS-164563).

With Liferay, you can create data sets from different resources available through RESTful APIs. With data sets, you can create and manage [data set views](./creating-data-set-views.md) to customize how you display your data set.
...
1. Choose the REST Application from a list of available options.
   ...
   ![Choose a REST application, Schema, and Endpoint to create your data set.](./creating-data-sets/images/03.png)
...
![Information about the data sets is shown in the data set manager. Search, filter, and manage your data sets using the data set manager.](./creating-data-sets/images/04.png)
...
![Use the filter to show/hide fields in the table.](./creating-data-sets/images/05.png)

Edit, rename, alter the permissions, or delete your data set in the data set's Action menu (![Actions menu](../../images/icon-actions.png))(9).

!!! tip
    Alternatively, click on the name of the data set to edit it.

![Use the actions menu to manage your data set.](./creating-data-sets/images/06.png)
