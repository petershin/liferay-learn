...
[서비스 액세스 정책](../../../installation-and-upgrades/securing-liferay/securing-web-services/setting-service-access-policies.md#understanding-service-access-policies) 은 Liferay 서비스에 대한 액세스를 제어합니다. 검색창 제안에 대한 정책은 기본적으로 활성화되어 인증되지 않은 사용자가 제안을 반환하는 REST 서비스 엔드포인트에 액세스할 수 있습니다. 즉, 게스트 사용자가 검색창에 입력할 때 검색창 제안을 활성화합니다.
...
다음은 시스템, 인스턴스 또는 위젯 [범위](../../../system-administration/configuring-liferay/understanding-configuration-scope.md)에서 검색 표시줄 제안을 활성화 또는 비활성화할 때 발생하는 상황입니다.

| 구성 범위   | 가능하게 하는? | 검색창 위젯 결과                                             |
|:------- |:-------- |:----------------------------------------------------- |
| 시스템 설정  | &#10008; | 모든 인스턴스의 기본값을 비활성화로 설정합니다. 제안 설정은 위젯 구성에 나타나지 않습니다.   |
| 인스턴스 설정 | &#10008; | 제안 설정은 위젯 구성에 나타나지 않습니다.                              |
| 인스턴스 설정 | &#10004; | 제안이 활성화되고 설정이 위젯 구성에 나타납니다. 제안은 위젯 구성에서 비활성화할 수 있습니다. |
