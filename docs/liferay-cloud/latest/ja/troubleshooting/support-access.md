...
サポートアクセスは、LiferayのエンジニアがLiferay Cloudのプロジェクト環境に直接アクセスすることで、トラブルシューティングを迅速に行えるようにするためのオプション設定です。 Liferay Cloud の管理者は、個々のプロジェクト環境に対して Support Access を有効または無効にすることができます。
...
また、Liferay Cloudは、サポートアクセスの設定が変更されると、チームメンバー全員にメールを送信します。
