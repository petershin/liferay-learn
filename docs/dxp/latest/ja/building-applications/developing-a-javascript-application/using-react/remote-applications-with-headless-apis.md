...
1. URL Pattern*を `/o/c/*` の値で追加し、*Save* をクリックします。これで、すべてのオブジェクトAPIに対してCORSが有効になります。

   ![オブジェクトAPI用の/o/c/* URLパターンを追加する](./remote-applications-with-headless-apis/images//01.png)

## CRUDアプリケーションのオブジェクトを作成する

1. グローバルメニュー*(！[グローバルメニュー](../../../images/icon-applications-menu.png)）を開き、*コントロールパネル*タブをクリックし、*オブジェクト*に移動します。

1. 追加*ボタン(![ボタン追加](../../../images/icon-add.png))をクリックし、以下の値を入力します：

   | フィールド｜値｜を入力します。
   | :--- | :--- |
   | ラベル｜J4X7-Object｜J4X7-Object｜J4X7-Object.com
   | 複数形ラベル｜J4X7-Objects｜日本経済新聞社
   | 名前｜J4X7Object｜｜です。
