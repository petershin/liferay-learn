...
| Message Boards             | Adds a [Message Boards widget](../../../../collaboration-and-social/message-boards/user-guide/getting-started-with-message-boards.md) to add the Message Boards application to a page.      |
...
| Search Insights          | Adds a [Search Insights widget](../../../../using-search/search-pages-and-widgets/search-insights.md) to inspect the query string constructed by back-end search code when a keyword is entered and the response string returned from the search engine. This is intended to be used only during testing and development. |
