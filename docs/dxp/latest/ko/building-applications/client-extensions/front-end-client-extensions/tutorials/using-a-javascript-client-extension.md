...
JavaScript(JS) 클라이언트 확장을 사용하면 Liferay 코드에 대한 종속성이나 테마 개발에 대한 걱정 없이 Liferay의 모든 페이지에서 자체 JavaScript를 실행할 수 있습니다. 여기에서 JavaScript 클라이언트 확장으로 시작합니다( [샘플 작업 공간](https://github.com/liferay/liferay-portal/tree/master/workspaces/sample-workspace)에서).
