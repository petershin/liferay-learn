...
The Blade CLI allows you to easily generate the skeleton for many types of client extensions, including CSS extensions. Follow these steps to get started:
...
You must configure a page in your Liferay instance to specifically use your deployed client extension. Follow these steps to see your CSS in use:
...
1. In the *CSS Client Extensions* section toward the bottom of the page, click *Add CSS Client Extensions*.
    ...
    ![Add the CSS client extension from this menu. It will appear in a list of any deployed CSS client extensions.](./creating-your-first-css-client-extension/images/03.png)
