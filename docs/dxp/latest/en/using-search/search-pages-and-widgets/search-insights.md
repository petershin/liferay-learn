...
Under the hood, the Explain option in the Search Insights widget exposes an Elasticsearch API: [Explain](https://www.elastic.co/guide/en/elasticsearch/reference/8.13/search-explain.html). See the Elasticsearch documentation for more details.
