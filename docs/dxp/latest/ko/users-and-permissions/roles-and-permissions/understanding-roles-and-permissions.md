...
사이트 범위 역할을 사이트 역할이라고 합니다. 사이트 역할에 대한 권한은 전역 수준에서 정의되며 하나의 [사이트](../../site-building/getting-started-with-site-building.md)에 적용됩니다. 개별 사용자, 조직 및 사용자 그룹을 사용하여 사이트 구성원을 제어하고 사이트 역할을 할당할 수 있습니다.
