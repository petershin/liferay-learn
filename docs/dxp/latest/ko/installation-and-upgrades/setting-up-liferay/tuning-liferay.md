...
Liferay는 연결 풀링에 HikariCP를 사용합니다. 데이터베이스 연결은 [JDBC 섹션](https://learn.liferay.com/reference/latest/en/dxp/propertiesdoc/portal.properties.html#JDBC)아래의 [Portal Properties](../reference/portal-properties.md) 로 구성됩니다.
