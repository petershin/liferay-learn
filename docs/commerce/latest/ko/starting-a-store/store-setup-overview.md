...
Liferay Commerce는 Liferay DXP를 기반으로 합니다. Liferay DXP 사이트의 작동 방식에 대한 자세한 내용은 [사이트 추가](https://learn.liferay.com/ko/w/dxp/site-building/sites/adding-a-site) 참조하십시오.
