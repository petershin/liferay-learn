...
The API builder makes it easy for you to create custom API applications in Liferay. Follow the steps below to see a mock API application example of a school's courses and students.
...
1. Click the _Add_ (![Add icon](../images/icon-add.png)) icon. Input the following for the new API application.
    ...
    ![Create a new API application](./api-builder/images/01.png)
...
1. Click the _Properties_ tab of the newly created schema. Add the `Course Name` field by clicking on _Course Name_ in the left menu.
    ...
    ![Add the course name field to the schema.](./api-builder/images/02.png)
