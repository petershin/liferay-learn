...
The web contents, structure, and template are imported. Now, create a collection to display the content in a page.
...
1. Double-click the first Dialect Text component inside the Collection Item's Container. Under the Mapping tab, change the Field to `Job Title`.
   ...
   ![Alter one of the components in a collection display and the other occurrences change as well.](./creating-the-careers-page/images/01.gif)
