...
When using an Asset Publisher widget, you can configure several display settings to specify how users view your content. To configure your Asset Publisher widget:
...
| Display Style | Specify the display style for the selected social media links. **Inline**: display icons for the selected sites in a line. **Menu**: show a Share button with a dropdown menu with selected sites as options.
...
The Grouping section specifies what groups to divide the displayed assets into. You can group assets by type or by [vocabulary](../../../content-authoring-and-management/tags-and-categories/defining-categories-and-vocabularies-for-content.md) (if you have defined some).
