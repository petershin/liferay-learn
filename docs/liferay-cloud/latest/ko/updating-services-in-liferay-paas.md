...
* [배포 유형 이해](./updating-services-in-liferay-paas/understanding-deployment-types.md)
* [배포 전략 이해](./updating-services-in-liferay-paas/understanding-deployment-strategies.md)
...
* [CI 서비스 빌드 자동 배포](./updating-services-in-liferay-paas/automatically-deploying-ci-service-builds.md)
* [Jenkins 단계 다시 시작](./updating-services-in-liferay-paas/restarting-jenkins-stages.md)
* [영구 파일 스토리지 볼륨 구성](./updating-services-in-liferay-paas/configuring-persistent-file-storage-volumes.md)
* [파일 및 폴더 무시](./updating-services-in-liferay-paas/ignoring-files-and-folders.md)
