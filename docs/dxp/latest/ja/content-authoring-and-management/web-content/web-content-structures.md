...
- [ストラクチャーとテンプレートへの権限の割り当て](./web-content-structures/assigning-permissions-to-structures-and-templates.md)
- [Liferay 7.4におけるWebコンテンツストラクチャーの新機能](./web-content-structures/whats-new-with-web-content-structures-in-7-4.md)
