...
1. Follow the steps outlined in [Overview of the Liferay Cloud Deployment Workflow](../using-the-liferay-dxp-service/overview-of-the-liferay-cloud-deployment-workflow.md) to deploy the script to the appropriate environment.
