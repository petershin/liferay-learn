...
이전 버전의 Liferay에서 사이트 관리자는 사이트 관리 &rarr; 콘텐츠 및 데이터 메뉴에서 전용 투표 응용 프로그램에 액세스할 수 있었습니다. 이 응용 프로그램은 Liferay 7.3 [에서 사용되지 않으며](../../installation-and-upgrades/upgrading-liferay/reference/maintenance-mode-and-deprecations-in-7-3.md#features-deprecated-in-7-3)</a>
제거되었습니다.</p> 
