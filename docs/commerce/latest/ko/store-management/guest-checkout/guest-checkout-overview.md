...
게스트 체크아웃에는 _게스트 체크아웃 인증_ 위젯이 있는 [사이트 페이지](https://learn.liferay.com/dxp/latest/en/site-building/creating-pages.html) 이 필요합니다. 이 페이지와 위젯을 생성하려면 [채널 설정](../../store-management/channels/channels-reference-guide.md) 에서 Health Check 기능을 사용하십시오.
