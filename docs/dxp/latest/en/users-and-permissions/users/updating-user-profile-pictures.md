...
The default user icon (with the user initials) can be configured to work for your locale. These settings are configured in a [Language Settings module](../../building-applications/core-frameworks/localization/adding-a-language.md).
