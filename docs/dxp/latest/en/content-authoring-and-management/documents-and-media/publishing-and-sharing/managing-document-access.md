...
Effectively managing document access in Liferay ensures that your organization’s data remains secure while being accessible to the right users.

Control document access by [setting specific permissions](./managing-document-access/permissions-and-documents.md). Define who can create, view, download, and manage Documents and Media assets, whether they're individual files, an entire folder, or a specific file type to maintain tight security over your content. Refer to the [documents and media permissions reference](./managing-document-access/documents-and-media-permissions-reference.md) for detailed information on permissions.
