...
| commerceアカウントウィジェット                            | 削除済み                    | DXP/Portalアカウントウィジェットに置き換わりました。                                                                                                                                                                                                                       |
| 中央認証サービス（CAS）                              | アーカイブ済み                 | 7.2で廃止。 SAML、OpenID Connect、Token-based SSOなど、他のソリューションに置き換えられています。                                                                                                                                                                                   |
| commerceカテゴリ・ナビゲーションウィジェット                     | バンドル                    | [表示ページテンプレート](../../../site-building/displaying-content/using-display-page-templates.md) [メニュー表示](../../../site-building/site-navigation/configuring-menu-displays.md) 対応に置き換わりました。                                                                   |
| commerceの素材リスト（BOM）について                        | 削除済み                    | commerceBOMに置き換えられます。                                                                                                                                                                                                                                     |
| commerceカテゴリーコンテンツウィジェット                       | バンドル                    | [ディスプレイページテンプレート](../../../site-building/displaying-content/using-display-page-templates.md)で置き換えられました。                                                                                                                                               |
