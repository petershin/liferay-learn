...
**사용자 DN:** 사용자가 저장된 LDAP 트리의 사이트를 입력합니다. Liferay는 사용자를 이 사이트로 내보냅니다.
...
**그룹 DN:** 그룹이 저장된 LDAP 트리의 사이트를 입력합니다. Liferay는 내보내기를 수행할 때 그룹을 이 사이트로 내보냅니다.
...
모든 옵션을 설정하고 연결을 테스트했으면 **저장** 클릭합니다.
