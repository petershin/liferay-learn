...
1. **Configuration** &rarr; **Plugins** 로 이동합니다. **Liferay FreeMarker 템플릿 플러그인** 을 클릭하세요.
...
1. **Transactions** 탭으로 이동하여 드롭다운 메뉴에서 **FreeMarker Templates** 를 선택하세요. 모든 템플릿 거래 목록이 나타납니다.

1. 특정 트랜잭션의 세부정보를 보려면 트랜잭션 패널에서 **느린 추적** 탭을 클릭하세요.
...
1. 더 아래로 스크롤하여 **Trace items** 를 클릭하세요. 추적이 확장되어 조각 변환의 세부정보가 표시됩니다.
...
1. **Errors** 탭으로 이동하여 드롭다운 메뉴에서 **FreeMarker Templates** 를 선택하세요.
