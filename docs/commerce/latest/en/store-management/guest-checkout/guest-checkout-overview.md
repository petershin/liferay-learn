...
Guest checkout requires a [site page](https://learn.liferay.com/w/dxp/site-building/creating-pages) with the _Guest Checkout Authentication_ widget. Use the Health Check function on the [Channels setting](../../store-management/channels/channels-reference-guide.md) to generate this page and widget.
