...
1. _전역 메뉴_ ![전역 메뉴](../../../images/icon-applications-menu.png)를 열고 _제어판_ 탭을 클릭한 다음 _시스템 설정_ 또는 _인스턴스로 이동합니다. 설정_.

   ```{note}
   Liferay DXP 7.4 U38+/GA38+부터는 인스턴스 수준에서 세그먼트 설정을 구성할 수 있습니다.
   ```

1. 콘텐츠 및 데이터에서 _세그먼트_를 클릭하세요.
...
_Analytics Cloud Segments_에서 다음 설정에 액세스할 수 있습니다.
...
_세그먼트 서비스_에서 다음 설정에 액세스할 수 있습니다.
...
* [Analytics Cloud 세그먼트](https://learn.liferay.com/analytics-cloud/latest/en/people/segments/segments.html)
