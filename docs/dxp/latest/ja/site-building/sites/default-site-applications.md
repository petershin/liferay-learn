...
| [ナレッジベース（管理）](../../collaboration-and-social/knowledge-base.md)                           | サイトの公式ドキュメントを作成し、表示する。                           |
...
| [翻訳](../../content-authoring-and-management/translating-pages-and-content.md)             | サイトページやコンテンツの翻訳プロセスを管理する。                        |
...
| [リダイレクト](../site-settings/managing-site-urls/setting-up-redirects-and-404-tracking.md) | HTTPリダイレクトの追加と管理、404エラーの追跡が可能です。                    |
...
| [インポートする](./exporting-importing-site-pages-and-content.md) | LARファイルからサイトページやコンテンツをインポートすることができます。                      |
