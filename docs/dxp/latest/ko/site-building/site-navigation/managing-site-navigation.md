...
**Site Builder** &rarr; **Pages** 메뉴에 새 페이지가 생성됩니다. 페이지를 추가하는 방법은 [사이트에 페이지 추가](../creating-pages/adding-pages/adding-a-page-to-a-site.md) 을 참조하십시오.
...
사이트의 페이지 계층 구조를 관리하는 또 다른 방법은 페이지 트리 **을 사용하는** 입니다. 여기에서 현재 사이트의 페이지를 보고 구성할 수 있습니다.
