...
While enabled, the Delete action moves assets to the recycle bin for recyclable assets (i.e., folders, web content, blogs, bookmarks, documents, media, message boards, and wikis).
