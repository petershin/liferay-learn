...
The [API Explorer](https://learn.liferay.com/w/dxp/headless-delivery/consuming-apis/consuming-rest-services) lists all of the `User` services and schemas and has an interface to try out each service.
