...
- Liferay DXP is connected to Analytics Cloud. Fore information on how to set up this connection, see [Connecting your Liferay DXP site to Analytics Cloud](https://learn.liferay.com/w/analytics-cloud/connecting-data-sources/connecting-liferay-dxp-to-analytics-cloud).
