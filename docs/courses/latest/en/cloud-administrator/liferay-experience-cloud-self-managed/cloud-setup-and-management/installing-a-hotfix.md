...
Keeping your Liferay instance up-to-date is a critical part of maintenance in Liferay Cloud. However, you might need to resolve the issue before you're ready to [update to the new version of Liferay](https://learn.liferay.com/w/liferay-cloud/using-the-liferay-dxp-service/updating-your-dxp-instance-to-a-new-minor-version). Hotfixes are the temporary solution to fix these issues until you are ready to update to the fixed version.

Here, you'll walk through the process of requesting and installing a hotfix.

```{important}
When you install a hotfix, reserve some downtime for your site ahead of time so you can deploy and verify the fix was successful in production.
```
