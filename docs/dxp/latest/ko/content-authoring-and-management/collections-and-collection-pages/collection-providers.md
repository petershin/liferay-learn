...
**동일한 범주의 항목:** 보고 있는 기본 항목과 동일한 범주의 항목을 표시합니다. 예를 들어 메인 아이템의 카테고리가 **football** 이라면 같은 카테고리의 아이템이 나타납니다. **고급 규칙** 에서 **Any Category of the Same Vocabulary** 또는 **A Specific Category** 를 선택하여 결과를 더 세분화할 수 있습니다.
