...
1. 編集したいアカウントの _オプション_ アイコン (![Options icon](../../images/icon-actions.png)) をクリックし、 _ユーザー管理_をクリックします。

1. _追加_ アイコンをクリックし、アカウントに割り当てるユーザーを選択します。
...
1. 編集したいアカウントの _オプション_ アイコン (![Options icon](../../images/icon-actions.png)) をクリックし、 _編集_をクリックします。

1. ユーザーセクションで、 _Assign_ ボタンをクリックし、ユーザーを選択します。 _Choose_ ]ボタンをクリックします。
