...
!!! note
    Beginning with Liferay DXP 2024.Q2/Portal 7.4 GA120, you can provide the frontend token definition in a [theme CSS client extension](../../../../liferay-development/customizing-liferays-look-and-feel/using-a-theme-css-client-extension.md) that you [apply to all the site's pages](../../../../liferay-development/customizing-liferays-look-and-feel/using-a-theme-css-client-extension.md#apply-the-theme-css-client-extension-to-a-page). Earlier releases required a theme module.
