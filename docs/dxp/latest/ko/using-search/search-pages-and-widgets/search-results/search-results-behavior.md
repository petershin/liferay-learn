...
콘텐츠 페이지에 대해 인덱싱된 필드를 검색하려면 검색 결과 위젯의 **문서 양식** 에 결과 표시 설정을 활성화합니다. 자세한 내용은 [검색 엔진 문서 검사](./configuring-the-search-results-widget.md#inspecting-search-engine-documents) 참조하십시오.
