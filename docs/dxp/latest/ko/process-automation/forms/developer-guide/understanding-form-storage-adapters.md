...
DDM(Dynamic Data Mapping) 백엔드는 양식 레코드의 다른 저장 형식에 **적응** 할 수 있습니다. 이를 통해 양식 데이터를 기본 JSON 대신 XML 또는 YAML(또는 원하는 형식)로 쉽게 직렬화할 수 있습니다. 그런 다음 Liferay 데이터베이스를 포함하여 어디에나 양식 데이터를 저장하도록 선택할 수 있습니다.
