...
[Liferay가 직면한 주요 경쟁사](../level-0/main-competitors-faced-by-liferay.md)의 레벨 0 세션에서는 Liferay의 주요 경쟁사 4개를 상당히 세부적인 수준으로 진행했습니다. 이 모듈에서는 일반적인 전투 카드에 중점을 두고 전투 카드가 어떻게 구축되고 유지되는지, 어디에서 찾을 수 있는지, 어떻게 구성되어 있는지를 다룹니다.
...
Liferay의 영업 지원 팀은 Kompyte라는 선도적인 타사 인텔리전스 도구를 사용하여 선택한 경쟁업체의 정보를 하나의 중앙 사이트로 수집합니다. 이는 공개적이고 일반적으로 신뢰할 수 있는 소스에서 상대적으로 빠르게 기본 데이터를 사용하여 배틀카드를 생성하고 업데이트하는 데 도움이 됩니다.
...
* [파트너](https://partner.liferay.com/marketing/marketing-resources/research-analysis/competitive-analysis)
* [직원](https://sales.liferay.com/en/group/library/competitive-intel)
