...
1. カスタムオブジェクトのデフォルトレイアウトとビューに、リレーションシップフィールドを追加します。 詳細な手順については、 [オブジェクトレイアウトの設計](../layouts/designing-object-layouts.md) および [オブジェクトビューの設計](../views/designing-object-views.md) を参照してください。
