...
다음으로 더 자세히 알아보기 위해 더 깊이 파고들 것입니다.
...
축하합니다! 이제 `CommerceDiscountRuleType` 인터페이스를 구현하기 위한 기본 사항을 알고 있으며 Liferay Commerce에 사용자 정의 UI 입력이 있는 새로운 할인 규칙 유형을 추가했습니다.
