...
1. **개인** 메뉴 &rarr; **알림** 을 클릭합니다.
1. 주문 워크플로 알림을 클릭합니다.
1. 오른쪽 상단 모서리에 있는 **점 3개 아이콘** → **나에게 할당** 을 클릭합니다.
...
1. 오른쪽 상단 모서리에 있는 **점 3개 아이콘** → **승인**(또는 **거부**)을 클릭합니다.
...
1. 주석을 추가하고(선택 사항)**완료** 을 클릭합니다.
   ...
   ![주문을 승인(또는 거부)할 때 설명을 추가할 수 있습니다.](./approving-or-rejecting-orders-in-order-workflows/images/05.png)
    ...
    검토된 주문은 **My Workflow Tasks** 에 표시됩니다.
