...
標準ポートレットは、 [`@PortletApplication`](https://resources.learn.liferay.com/reference/latest/en/portlet-api/javax/portlet/annotations/PortletApplication.html) アノテーションを指定するだけで済みます。
