...
1. `LPKG` 을 `${liferay.home}/deploy` 폴더에 배포합니다.
    ...
    ```{note}
    Liferay DXP에 애플리케이션을 배포하는 방법에 대해 자세히 알아보려면 [Liferay 홈](https://learn.liferay.com/dxp/latest/en/installation-and-upgrades/reference/liferay-home.html)을 참조하십시오.
    ```
