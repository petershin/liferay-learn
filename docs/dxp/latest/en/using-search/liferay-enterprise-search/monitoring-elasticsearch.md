...
1. Begin configuring encryption by providing certificate files. See [Elastic's guide](https://www.elasticsearch.co/guide/en/kibana/8.13/using-kibana-with-security.html#using-kibana-with-security) for more details.
