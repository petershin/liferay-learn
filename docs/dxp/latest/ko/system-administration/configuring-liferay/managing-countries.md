...
1. 이름을 클릭하여 국가를 선택하거나 해당 국가에서 **옵션**(![Options icon](../../images/icon-actions.png))을 클릭하고 **편집** 을 클릭합니다. 특정 국가를 빠르게 찾으려면 검색창을 사용하세요.
...
1. **국가 에서 옵션**(![Options icon](../../images/icon-options.png)) 을 클릭 하고 **비활성화 를 클릭 하십시오** .
...
1. 검색 표시줄 옆에 있는 **필터 및 주문** 을 클릭하고 **비활성** 을 선택하여 비활성화된 국가 목록을 확인합니다. 특정 국가를 빠르게 찾으려면 검색창을 사용하세요.

1. **옵션**(![Options icon](../../images/icon-options.png)) 국가 를 클릭 하고 **활성화** 를 클릭 하십시오 . 이제 국가가 활성화됩니다.
...
1. **옵션**(![Options icon](../../images/icon-options.png)) 국가 를 클릭 하고 **삭제** 를 클릭 하십시오 .
...
1. 검색 표시줄 옆에 있는 **추가**(![Add icon](../../images/icon-add.png))을 클릭합니다. 국가를 추가하기 위한 새 페이지가 나타납니다.
