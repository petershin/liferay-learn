...
変更内容を確認する場合、追跡されたすべての変更内容がリストに表示され、変更タイプ、更新日、サイト、ステータス、タイトル、ユーザーで並べ替えることができます。
...
個々の変更をクリックすると、詳細が表示されます。 ここから、トラックした変更のアクションボタン（ ![Actions button](../../../images/icon-actions.png) ）をクリックして、編集または破棄することも可能です。 使用可能なアクションは、変更のタイプによって異なります。
...
![表示タブでページのバージョンを表示する。](./making-and-publishing-changes/images/06.png)

選択すると、各ページのバージョンを個別に表示したり、分割表示を選択して両方のバージョンを並べて表示したりすることができます。

![各ページのバージョンを個別に表示したり、分割表示を選択して並べて表示することができます。](./making-and-publishing-changes/images/07.png)
...
1. ［**公開**］ をクリックします。
   ...
   ![目的のパブリケーションに移動し、「パブリッシュ」をクリックします。](./making-and-publishing-changes/images/08.png)
...
1. 変更をプロダクションに公開するタイミングを決定する日時を入力します。

   ![変更を公開する日時を設定します。](./making-and-publishing-changes/images/11.png)

1. **スケジュール** をクリックし、処理を完了します。

[これにより、「スケジュール」タブに移動し、スケジュールされた出版物の表示と管理](./creating-and-managing-publications.md#managing-scheduled-publications) を行うことができます。
...
1. 選択 **削除 DL プレビュー 変更 追従 保存 コンテンツ データ** .
   ...
   ![変更追跡オプションを確認する。](./making-and-publishing-changes/images/12.png)
