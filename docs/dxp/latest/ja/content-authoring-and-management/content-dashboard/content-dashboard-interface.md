...
コンテンツダッシュボードインターフェースには、次の領域があります。
...
1. グローバルメニューが無効になっている場合は、プロダクトメニューを開き、*サイト*メニューの下にある*［Content］* &rarr; *［Content Dashboard］*に移動します。
...
1. *［上へ］*（![Up](../../images/icon-angle-up.png)）と*［下へ］*（![Down](../../images/icon-angle-down.png)）ボタンをクリックして、表軸のボキャブラリの順番を決めます。
1. *［保存］*をクリックします。
...
```{note}
グローバルサイトレベルで定義された2つのボキャブラリの最大値を選択できます。
```
...
| タイトル               | 記事のタイトル（*）。                                                                                                                                                                                       |
| 作成者                | 作成者の名前。                                                                                                                                                                                           |
| タイプ                | [Webコンテンツの記事](../web-content/web-content-articles/adding-a-basic-web-content-article.md)または[ドキュメント](../documents-and-media/documents-and-media-overview.md)アセットタイプ(Liferay DXP 7.4+にて利用可能)を特定します。 |
...
（*）*ページ*（![Page](../../images/icon-page.png)）アイコンは、[表示ページテンプレート](../../site-building/displaying-content/using-display-page-templates/about-display-page-templates-and-display-pages.md)に基づく記事を示します。
...
- *View*（![View](../../images/icon-preview.png)）：表示ページテンプレートに基づいて閲覧モードでコンテンツを開きます。
...
- *View Metrics*（![View Metrics](../../images/icon-analytics.png)）: [コンテンツパフォーマンスサイドバー](../content-performance-tool/about-the-content-performance-tool.md)を開きます。

    ![アクションメニューまたは各コンテンツ行のアイコンから、コンテンツ情報サイドバーとコンテンツパフォーマンスパネルにアクセスします。](./content-dashboard-interface/images/11.png)

```{note}
表示ページテンプレートに基づくコンテンツには、*View*、*Info*、および*View Metrics*オプションを使用します。 コンテンツの編集権限がある場合は、*Edit*オプションを使用します。
```
