...
![The Message Boards app is fantastic for facilitating discussions.](./collaboration-and-social/images/01.png)

To begin using the Message Board app to build a forum, see [Message Boards](./collaboration-and-social/message-boards.md).
...
To begin creating a wiki, see [Wiki](./collaboration-and-social/wiki.md).

## Social Tools

The following social applications are included with Liferay DXP:

- [Activities](./collaboration-and-social/social-tools/using-the-activities-widget.md)
- [Contacts Center](./collaboration-and-social/social-tools/using-the-contacts-center-widget.md)
...
![The Activities widget tracks user activities.](./collaboration-and-social/images/03.png)
...
![Inviting members to a site.](./collaboration-and-social/images/04.png)

Once the user has been invited, they can confirm or ignore the request.

![You can confirm a request to join a site.](./collaboration-and-social/images/05.png)
...
![The Knowledge Base widget can also be used to publish articles.](./collaboration-and-social/images/06.png)
