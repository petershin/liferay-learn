...
See the [Elasticsearch date-math documentation](https://www.elastic.co/guide/en/elasticsearch/reference/8.8/common-options.html#date-math) to understand more about how to specify the ranges.
