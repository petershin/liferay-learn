...
청사진은 Elasticsearch에 대한 Liferay의 검색 요청 내용을 제어하는 방법입니다. 따라서 사용자의 검색 경험이 작동하는 방식에 대한 이해와 기본 Liferay 검색 쿼리의 주요 구성 요소에 대한 높은 수준의 이해를 결합하는 것이 도움이 됩니다(시작할 필요는 없음).
...
**절:** A 절은 기본 `bool` 쿼리의 독립적인 부분입니다. 가장 자주 중첩된 쿼리 중 하나는 _절_ 단어가 호출될 때 참조되는 것입니다.
