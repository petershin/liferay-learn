...
완료되면 [사이트](../creating-sites.md)을 사용하여 사이트를 만들 수 있습니다.
...
1. **내보내기** 또는 **가져오기** 탭으로 이동하여 원하는 프로세스를 시작합니다.
   ...
   대량 가져오기에 대한 구성 옵션은 개별 사이트 템플릿을 [때와 대부분 동일](#importing-individual-site-templates) . 그러나 LAR 파일에 포함된 페이지 템플릿을 사이트 템플릿과 함께 가져올지 여부는 결정할 수 있습니다.
