...
```{note}
If the service doesn't have a `*ServiceUtil` class, use a [Service Tracker](../../liferay-development/core-frameworks/dependency-injection.md) to access the service.
```
