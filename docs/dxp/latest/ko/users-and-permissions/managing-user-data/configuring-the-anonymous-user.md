...
인터넷 사용자는 자신이 사용하는 시스템에서 자신의 개인 데이터가 처리되는 방식에 대해 점점 더 많은 관심을 기울이고 있습니다. Liferay는 사용자 데이터 관리를 처리하기 위한 기능의 필요성을 인식하고 있습니다. [사용자 데이터 삭제](./sanitizing-user-data.md#the-personal-data-erasure-screen) 은 _잊혀질 권리_ 요청을 존중하는 가장 안전한 방법입니다.
