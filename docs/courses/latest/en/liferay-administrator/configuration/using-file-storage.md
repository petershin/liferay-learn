...
<!-- Why did you choose this? Surely, we provide cloud storage as part of LXC and/or LXC-SM? We should default to that. -Rich -->
...
1. Enter the settings.
   ...
   * Service Account Key: The private JSON key provided by Google.
   ...
   ![Enter the google cloud storage settings.](./using-file-storage/images/01.png)
