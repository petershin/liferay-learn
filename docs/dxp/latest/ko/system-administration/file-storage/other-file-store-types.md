...
* [IBM 클라우드 오브젝트 스토리지](./other-file-store-types/ibm-cloud-object-storage.md)
* [구글 클라우드 저장소](./other-file-store-types/google-cloud-storage.md)
* [Microsoft Azure 블로그 스토리지 서비스](./other-file-store-types/microsoft-azure-blob-storage.md)