...
Liferay 7.4를 사용 중이고 Liferay Enterprise 검색 응용 프로그램을 사용하는 경우 [Liferay DXP와 함께 번들](../../../liferay-enterprise-search/activating-liferay- 기업 검색.md). Liferay 7.2 또는 7.3을 사용 중인 경우 계속 읽어 애플리케이션을 설치하세요.
