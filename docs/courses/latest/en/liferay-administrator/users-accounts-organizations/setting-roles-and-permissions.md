...
1. In the new page, click the _Assignees_ tab. 
   ...
   - In the new window, select _Kyle Klein_. 
   - Click _Add_. 

   Kyle now has the administrator role.

You can also assign users roles from the edit user page. 
...
1. In the left navigation, click _Roles_. 

   - Click _Select_ next to regular roles. 
   - In the new window, click _Choose_ for administrator. 
   - Click _Save_ at the bottom of the page. 

   Now Marcus has also been assigned the administrator role.
