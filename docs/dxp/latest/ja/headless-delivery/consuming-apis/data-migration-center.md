...
1. _Templates_タブをクリックすると、インポートおよびエクスポートテンプレートのリストが表示されます。
...
1. エクスポートプロセスを表示するウィンドウが表示されます。 ジョブが完了したら、_Download_をクリックしてzipファイルをダウンロードします。 zipファイルがあなたのローカルマシンにダウンロードされます。
...
1. _Next_をクリックしてインポートを続行します。 ポップアップウィンドウで、_Start Import_をクリックする。
