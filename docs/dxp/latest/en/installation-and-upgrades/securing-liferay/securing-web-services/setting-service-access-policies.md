...
| **SEARCH_SUGGESTIONS**     | Allows access to country/region services so users can switch languages on the fly. Applies to every request, including unauthenticated requests.                                                                                                                                                                                                                                                                                                                                                                             | &#10004;           |
| **SYSTEM_DEFAULT**         | Allows access to country/region services so users can switch languages on the fly. Applies to every request, including unauthenticated requests.                                                                                                                                                                                                                                                                                                                                                                             | &#10004;           |
...
1. (Optional) Toggle *Default* if you want the policy applied to unauthenticated and authenticated requests.
...
Deployed Liferay applications can declare their own default policies. These can then be changed or disabled by administrators. Plugins can always verify the policy exists even if you redefine or update it.
...
1. Open the *Global Menu* (![Global Menu](../../../images/icon-applications-menu.png)) and navigate to *Control Panel* &rarr; *System Settings* &rarr; *API Authentication*.
   ...
   ![Access the Service Access Policy.](./setting-service-access-policies/images/02.png)
