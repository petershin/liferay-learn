...
1. メニューから［ *掲示板* ］をもう一度クリックして、メッセージを表示します。 アクション ![Action](../../images/icon-actions.png)ボタンをクリックし、［ *Move to Recycle Bin*］を選択します。 メッセージはリサイクルされただけなので、まだログにメッセージが表示されていないことに注意してください。
