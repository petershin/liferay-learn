...
* **WYSIWYG 편집자** . 새로운 콘텐츠를 만드는 것보다 미리 만들어진 콘텐츠를 보여주고 내장된 WYSIWYG 편집기를 사용해 어떻게 편집할 수 있는지 보여주는 것이 더 효과적입니다.
* **자산마다 다른 디스플레이가 있습니다** . 기사, 사례 연구, 보도 자료 등 다양한 유형의 콘텐츠를 정의하고 다양한 방식으로 표시하는 방법을 보여줍니다.
...
Liferay는 또한 필요한 모든 페이지에서 간단한 구성을 통해 [다변수 테스트](https://learn.liferay.com/w/analytics-cloud/optimization/ab-testing)를 실행할 수 있는 기본 기능을 제공합니다. 평가되었습니다. 대부분의 경우 테스트를 완료하는 데 필요한 시간과 상호 작용 수 때문에 데모에서 실행 중인 A/B 테스트를 보여주기 위해 데이터를 준비하는 것은 실용적이지 않습니다. 특징.
