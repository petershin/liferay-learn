...
現在、Notification TemplatesはObjectアクションのみをサポートしています。 ただし、Commerce Channels には、Channel イベント用の通知テンプレート機能が組み込まれています。 詳しくは、 [Store Emails](https://learn.liferay.com/commerce/latest/en/store-management/sending-emails/store-emails.html) をご覧ください。
