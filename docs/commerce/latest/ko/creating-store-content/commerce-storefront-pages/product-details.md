...
아래에 강조 표시된 샘플 페이지는 Minium Accelerator를 사용하고 있으며 _개의 Product Details_, _Product Publisher_및 _Product Comparison Bar_ 위젯을 포함하고 있습니다.
...
위의 이미지에서 _제품 게시자_ 위젯은 동일한 범주 및 태그가 있는 유사한 항목을 표시하도록 구성됩니다. 상점 관리자는 이 위젯의 내용을 변경하여 다른 유형의 관련 제품을 표시할 수 있습니다. 자세한 내용은 [관련 제품, 상향 판매 및 교차 판매](../../product-management/creating-and-managing-products/products/related-products-up-sells-and-cross-sells.md)을 참조하십시오.
