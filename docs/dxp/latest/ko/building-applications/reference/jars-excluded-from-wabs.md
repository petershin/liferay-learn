...
[Liferay에서 생성된 웹 애플리케이션 번들 \(WABs\)](./deploying-wars-wab-generator.md) 은 Liferay가 이미 내보내는</a>
패키지가 포함된 타사 JAR에서 제거됩니다. 추가 JAR에서 동일한 타사 패키지를 배포하면 디버깅하기 어려운 이상한 오류가 발생할 수 있습니다. Liferay의 [`module.framework.web.generator.excluded.paths`](https://learn.liferay.com/reference/latest/en/dxp/propertiesdoc/portal.properties.html#Module%20Framework%20Web%20Application%20Bundles) [포털 속성](../../installation-and-upgrades/reference/portal-properties.md) 는 제외된 JAR을 지정합니다. 다음은 기본 `module.framework.web.generator.excluded.paths` 속성에서 발췌한 내용입니다.</p> 
