...
자세한 내용은 [개별 페이지 구성](https://learn.liferay.com/dxp/latest/en/site-building/creating-pages/page-settings/configuring-individual-pages.html)을 참조하십시오.
...
자세한 내용은 [조각 개발](https://learn.liferay.com/dxp/latest/en/site-building/developer-guide/developing-page-fragments/developing-fragments-intro.html)을 참조하십시오.
