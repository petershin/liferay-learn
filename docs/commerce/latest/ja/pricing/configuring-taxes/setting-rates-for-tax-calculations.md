...
1. _税計算_までスクロールします。
1. ［アドレス別］の横にある_［編集］_をクリックします。
1. _パーセント_および_有効_トグルを_はい_にスライドします 。
1. _［Save］_ をクリックします。

次に、カテゴリ別および住所別に税率を設定します。

1. _［税率設定］_をクリックします。
1. 課税住所地が請求先住所か配送先住所かを、_［税を適用］_ドロップダウンメニューから選択します。
1. 追加（![Add icon](../../images/icon-add.png)）ボタンをクリックして、税カテゴリを追加します。
1. ［税カテゴリ］を選択します（たとえば、 _Holiday Special_）。
1. 次のように入力します：
