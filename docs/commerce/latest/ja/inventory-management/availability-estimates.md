...
[アクセラレータ](../starting-a-store/accelerators.md) を使用してcommerceサイトを作成する場合、3つのサンプル見積もりが作成されます。

次の手順に従って、独自の入荷見積もりを作成します：

1. ［**グローバルメニュー**］（![Global Menu](../images/icon-applications-menu.png)）を開き、 ［**commerce**］ タブをクリックし、 ［**在庫数の見積もり**］ に進みます。
