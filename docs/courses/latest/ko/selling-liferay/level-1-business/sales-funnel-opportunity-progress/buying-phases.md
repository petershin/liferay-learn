...
그런 다음 마지막 단계에서 비용이 다시 한 번 중요해집니다. 모든 것이 초기 단계의 최종 단계에서 잘 수행되면 더 이상 **_비용_** 으로 간주되지 않습니다. 대신에 이는 문제 해결을 위한 **_가격_** 으로 발전합니다. 지금이 가격 세부 사항을 논의할 적절한 시기입니다. 초기 단계에서는 아마도 충분한 정보가 수집되지 않았고 아직 충분한 가치가 확립되지 않았을 것입니다.
