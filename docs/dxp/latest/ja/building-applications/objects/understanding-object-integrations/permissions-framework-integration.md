...
オブジェクトに追加された [スタンドアロン アクション](../creating-and-managing-objects/actions/using-manual-actions.md) ごとにリソース権限が生成されます。 アクションをトリガーできるロールを管理するのに役立ち、`action.[actionName]` パターンを使用して名前が付けられます。
