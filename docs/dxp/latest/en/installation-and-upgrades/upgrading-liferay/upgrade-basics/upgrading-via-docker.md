...
1. (Optional) [Enable batch insert](./using-the-database-upgrade-tool.md#batch-insert-property) by adding the JDBC property to your `portal-ext.properties` file.
