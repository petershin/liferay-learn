...
管理者は、ウィジェットページの一部またはすべてのセクション（ページレイアウトの行と列）を、サイトメンバーがカスタマイズできるものとして指定できます。 ページのカスタマイズは、カスタマイズを行ったユーザーに対してのみ表示されます。 以下の手順では、これらのトピックについて説明します。
...
1. サイトメンバーに修正させたいページの横にある **アクション** メニューを開き、 ［**構成**］ を選択します。
