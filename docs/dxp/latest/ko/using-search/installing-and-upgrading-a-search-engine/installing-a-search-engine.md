...
검색 엔진은 Liferay 설치의 중요한 구성 요소입니다. [예제 클러스터 생성](./../../installation-and-upgrades/setting-up-liferay/clustering-for-high-availability/example-creating-a-simple-dxp-cluster.md#prepare-a-search-engine) 에서 설치를 시작할 수 있지만 **가이드에서는** 환경 설정을 보여줍니다.
...
Elasticsearch 7 커넥터가 HTTP를 통해 통신하기 때문에 Java 버전 및 배포 요구 사항은 Liferay 7.3에 적용되지 않습니다. JVM 레벨 직렬화가 없습니다. 자세한 내용은 [Elastic의 고급 REST 클라이언트](https://www.elastic.co/guide/en/elasticsearch/client/java-rest/7.x/java-rest-high.html) 을 참조하세요.
...
* 원격 Elasticsearch 서버 또는 클러스터를 구성하려면 [Elasticsearch 시작하기](./elasticsearch/getting-started-with-elasticsearch.md)을 참조하십시오.
