...
1. _문서 유형_ 탭을 클릭합니다.
1. _추가 버튼_ (![Add](../../../../images/icon-add.png))을 클릭합니다. _새 문서 유형_ 양식이 나타납니다.
1. 이름을 입력하세요.
1. 설명을 입력합니다.
1. _기본 메타데이터 필드_ 섹션을 펼치십시오.
1. 메타데이터 필드를 편집기로 끌어다 놓습니다.

    ![기본 메타데이터 필드 끌어서 놓기](./defining-document-types/images/10.png)

1. _추가 메타데이터 필드_을 확장합니다.
...
이제 문서 및 미디어의 _추가_ 메뉴를 통해 문서를 추가할 때 새 문서 유형을 사용할 수 있습니다.
