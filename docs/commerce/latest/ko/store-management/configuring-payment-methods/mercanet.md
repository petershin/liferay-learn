...
[Mercanet](https://documentation.mercanet.bnpparibas.net/index.php?title=Obtenir_sa_cl%C3%A9_secr%C3%A8te#)을 사용하도록 상점을 구성하기 전에 다음을 생성해야 합니다.
...
1. 다음을 입력:
    ...
    * 귀하의 _비밀 키_
    * 귀하의 _키 버전_
1. 라이브 사이트인 경우 _프로덕션_ 을 선택하고 테스트 환경인 경우 _테스트_ 또는 _시뮬레이션_ 를 선택합니다. ![판매자 설정](./mercanet/images/02.png)
1. _저장_을 클릭합니다.
1. _Mercanet_ 옆에 있는 _점 3개 아이콘_ 을 클릭한 다음 _활성화_를 클릭합니다.
