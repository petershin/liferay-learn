...
2. **エンティティのバージョンを削除する方法を見つけます。** Liferay DXPの [アプリAPI](https://docs.liferay.com/dxp/apps/) と [com.liferay.portal.kernel API](https://resources.learn.liferay.com/reference/latest/en/dxp/javadocs/portal-kernel/) が使用可能なオプションです。
...
* [データベースの削除](./database-pruning-for-faster-upgrades.md)
* [データアップグレードの調整](./database-tuning-for-upgrades.md)
