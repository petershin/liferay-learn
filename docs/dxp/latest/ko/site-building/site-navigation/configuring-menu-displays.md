...
[메뉴 디스플레이](./using-the-navigation-menus-application.md)표시하고 구성하려면 [메뉴 디스플레이 조각](#configuring-the-menu-display-fragment) 또는 [메뉴 디스플레이 위젯](#configuring-the-menu-display-widget) 를 사용할 수 있습니다. 이 두 옵션 중 하나를 사용하여 사이트에 대한 메뉴 표시 옵션, 수준 및 동작을 정의할 수 있습니다.
...
| **레벨 수** | 표시할 레벨 번호를 0에서 4까지 선택합니다. 수준 0은 상위 페이지를 나타내고 수준 0은 첫 번째 수준의 하위 페이지를 나타냅니다.                                     |
