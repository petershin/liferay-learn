...
コンテントページとテンプレートを編集または作成する場合、それらに追加されたドキュメント、Webコンテンツ記事、コレクション、またはインラインテキストをすばやく表示および編集できます。 そのためには、編集サイドバーの「 *ページ内容」* ボタン(![Page Content](../../../images/icon-paperclip.png))を選択します。
