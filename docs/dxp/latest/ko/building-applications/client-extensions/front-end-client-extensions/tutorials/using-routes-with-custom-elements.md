...
1. 애플리케이션이 성공적으로 생성되었는지 확인합니다.
   ...
   이 스크립트는 다음 요소를 사용하여 `j1v3-custom-element` 이라는 새 React 애플리케이션을 생성합니다.
...
J1V3-Custom-Element는 인스턴스화할 수 있으므로 각각 고유한 독립적인 구성이 있는 많은 요소를 페이지에 추가할 수 있습니다. 이 예에서는 페이지에 위젯을 두 번 추가합니다.
