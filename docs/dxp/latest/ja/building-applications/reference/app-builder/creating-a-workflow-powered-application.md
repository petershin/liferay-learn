...
* [役割変更要求オブジェクトの作成](./creating-the-role-change-request-object.md) 
* [役割変更申請アプリの作成](./creating-the-role-change-request-app.md) 
...
| 追加の番号付きステップ（例：ステップ2、3、4など） | ステップ1と同じに加え、_Add New Action_オプションを追加する。                            | 追加のステップでは、ステップ1で実行できるすべてのことを実行できます。さらに、必要に応じて、前のワークフローステップに戻る新しいアクションを作成できます。                                                                                                                     |
