...
```{important}
動的データリストは、Liferay DXP7.3で非推奨になりました。 [アプリビルダー](../../../building-applications/app-builder.md) と [フォームレポート](../sharing-forms-and-managing-submissions/form-reports.md)に置換されました。
```
