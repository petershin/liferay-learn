...
카테고리 패싯을 구성하려면 패싯의 _옵션_ 메뉴(![Options](../../../images/icon-app-options.png))를 열고 *구성*클릭하십시오.
...
1. Foo 사이트의 홈 페이지에서 Foo 어휘의 범주만 표시하도록 구성된 범주 패싯 위젯을 추가합니다. 
   ...
   - 디스플레이 템플릿 선택기를 열고 _Vocabulary Layout_선택합니다.
   - 범주 매개변수 이름을 _foocategories_로 변경하십시오.
   - _어휘 선택_ 라디오 버튼을 클릭합니다. _Global_ 확장하고 _Foo_선택합니다.
   - _저장_클릭합니다.
