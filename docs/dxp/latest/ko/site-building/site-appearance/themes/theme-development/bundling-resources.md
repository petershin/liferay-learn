...
:::{grid-item-card} 썸네일 미리 보기를 테마에 번들링
:link: ./bundling-resources/bundling-a-thumbnail-preview-into-your-theme.md
:::

:::{grid-item-card} 테마를 통해 테마에 리소스 번들링 및 설치
:link: ./bundling-resources/번들링 및 설치 리소스-인테마에 테마를 통해 설치
:::

:::{grid-item-card} 테마 기여자를 통한 독립 UI 리소스 번들링
