...
페이지 조각은 [콘텐츠 페이지](../using-content-pages.md) 및 관련 템플릿(예: [마스터](../defining-headers-and-footers/master-page-templates.md), [페이지](../adding-pages/creating-a-page-template.md), [디스플레이 페이지](../../displaying-content/using-display-page-templates.md))을 구축하기 위한 확장 가능하고 재사용 가능한 드래그 앤 드롭 요소입니다. CSS, HTML 및 JavaScript를 사용하여 구축되며 페이지에 구조와 기능을 모두 제공할 수 있습니다.

![조각으로 콘텐츠 페이지 및 템플릿을 구축하세요.](./using-fragments/images/01.png)

Liferay는 다양한 조각을 기본으로 제공하지만, [페이지 조각 편집기](../../developer-guide/reference/fragments/page-fragment-editor-interface-reference.md) 또는 [조각 툴킷](../../developer-guide/developing-page-fragments/using-the-fragments-toolkit.md)을 사용하여 사용자 정의 조각을 개발할 수 있습니다. 또한, [Liferay 위젯](../../developer-guide/reference/fragments/fragment-specific-tags-reference.md#including-widgets-within-a-fragment) 을 조각에 임베드하거나 편집 가능한 필드를 추가할 수 있습니다. 자세한 내용은 [페이지 조각 개발](../../developer-guide/developing-page-fragments/developing-fragments-intro.md) 을 참조하세요.

양식으로 작업하는 경우 양식 필드를 사용자 지정 양식 조각에 [매핑하여](./using-fragments/personalizing-custom-forms-using-form-fragments.md)개인화할 수 있습니다.

모든 페이지 조각은 관리와 사용이 쉽도록 관련 조각을 그룹화하는 세트로 구성됩니다. 각 조각 세트에는 모든 조각에서 액세스할 수 있는 공통 리소스가 포함될 수 있습니다. 자세한 내용은 [페이지 조각에 기본 리소스 포함](../../developer-guide/developing-page-fragments/including-default-resources-with-fragments.md) 을 참조하세요.

페이지 또는 템플릿에 조각을 추가한 후 해당 조각과 하위 요소를 구성하고 사용자 지정할 수 있습니다. 이러한 옵션은 다양할 수 있지만 일부 옵션은 모두에게 공통적입니다. 사용 가능한 옵션에 대해 자세히 알아보려면 [조각 구성](./using-fragments/configuring-fragments.md) 을 참조하세요.
...
:::{grid-item-card} 프래그먼트 변경 사항 전파하기
