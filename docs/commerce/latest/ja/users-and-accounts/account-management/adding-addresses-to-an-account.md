...
1. アカウントを選択します。
1. ［**Addresses**］ タブをクリックします。

    ![アドレスタブの表示](./adding-addresses-to-an-account/images/01.png)

1. ［**Add Address**］ ボタンをクリックします。
1. ［**Shipping**］ または ［**Billing**］ いずれかを選択します。
1. フィールドに入力します。
...
ユーザーは、 ［**Control Panel**］ で、アカウントにアドレスを追加することができます。

1. **グローバル**（![Global Menu](../../images/icon-applications-menu.png)）ボタンをクリックして、 ［**Control Panel**］ をクリックします。
1. ［**Accounts**］ をクリックします。
...
1. アドレスフィールドを記入します。
1. これがデフォルトの請求先住所である場合は、 ［**Default Billing**］ ボックスをオンにします。
1. これがデフォルトの配送先住所である場合は、 ［**Default Shipping**］ ボックスをオンにします。
