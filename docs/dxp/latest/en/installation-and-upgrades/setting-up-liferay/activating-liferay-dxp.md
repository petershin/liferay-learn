...
The license manager page displays server and license information. To see the page, click _License Manager_ on the activation page. Or if you have previously activated your Liferay instance, log in as an administrator and navigate to _Control Panel_ &rarr; _License Manager_.
