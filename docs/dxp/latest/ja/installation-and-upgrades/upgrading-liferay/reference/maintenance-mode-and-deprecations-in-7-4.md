...
| 機能                                | 利用可能                    | メモ                                                                                                                                                                                                                                                    |
|:--------------------------------- |:----------------------- |:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| App Builder, App Builderワークフロー    | 削除                      | [Liferay Objects](../../../building-applications/objects.md)によって置き換えられました。                                                                                                                                                                            |
| Bootstrap 3 & Bootstrap 4 互換性レイヤー | 削除                      | [Theme upgrade](../../../site-building/site-appearance/themes/upgrading-a-theme.md)時に互換性レイヤーを追加することを選択するか、手動でレイヤーを追加します。                                                                                                                              |
| コマースアカウントウィジェット                   | 削除                      | DXP/Portalアカウントウィジェットに置き換わりました。                                                                                                                                                                                                                       |
| 中央認証サービス（CAS）                     | アーカイブ済み                 | 7.2で廃止。 SAML、OpenID Connect、Token-based SSOなど、他のソリューションに置き換えられています。                                                                                                                                                                                   |
| コマースカテゴリ・ナビゲーションウィジェット            | バンドル                    | [ディスプレイページテンプレート](../../../site-building/displaying-content/using-display-page-templates/about-display-page-templates-and-display-pages.md) [ナビゲーションメニュー](../../../site-building/site-navigation/configuring-navigation-menus.md) のサポートに置き換えられました。    |
| コマースの素材リスト（BOM）について               | 削除                      | コマースBOMに置き換えられます。                                                                                                                                                                                                                                     |
...
| EXTプラグインサポート                      | 削除                      | 構成設定や標準的な拡張ポイントに置き換えられました。                                                                                                                                                                                                                            |
| イメージエディター（Soyベース）                 | 削除                      | Reactベースのイメージエディターに置き換えられました。                                                                                                                                                                                                                         |
...
| モバイルSDK                           | 削除                      | [ヘッドレスデリバリー](../../../headless-delivery/using-liferay-as-a-headless-platform.md)に置き換えられました。                                                                                                                                                           |
...
| アンケート                             | 削除                      | [Forms/Forms Reports](../../../process-automation/forms/sharing-forms-and-managing-submissions/form-reports.md)に置き換わりました。                                                                                                                             |
...
| Solrコネクター                         | 削除                      | 7.3で廃止。 Elasticsearchに置き換えられました。                                                                                                                                                                                                                      |
