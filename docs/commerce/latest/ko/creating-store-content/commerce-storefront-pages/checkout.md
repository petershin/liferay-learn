...
체크아웃 페이지에는 **체크아웃** 위젯이 포함되어 있습니다. 구매자가 주문을 제출하기 위해 **체크아웃** 을 클릭하면 활성화됩니다. 확장 포인트를 사용하여 사용자 정의 체크아웃 단계를 구현할 수도 있습니다. 자세한 내용은 [사용자 정의 체크아웃 구현](../../developer-guide/implementing-a-custom-checkout-step.md) 단계를 참조하십시오.
...
구매자가 **배송 주소를 청구 주소로 사용** 을 선택하면 청구 주소 페이지를 건너뜁니다.
