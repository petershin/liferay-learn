...
個人のためのデータモデルは、連絡先データが[DXPから同期された時](../../connecting-data-sources/syncing-contact-data-from-dxp.md)または[CSV](../../connecting-data-sources/adding-a-csv-data-source.md)などの他のデータソースから同期されたときにマッピングされるさまざまな属性で定義されます。
