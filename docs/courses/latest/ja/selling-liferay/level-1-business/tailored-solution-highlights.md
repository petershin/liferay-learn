...
```{note}
* このモジュールのライブワークショップの [recording](https://learn.liferay.com/web/guest/d/sa1-1-liferay-tailored-solution-highlights) をご覧ください。
...
* 統合 & 相互運用性
* [開発ツール](https://learn.liferay.com/w/dxp/building-applications/tooling/liferay-workspace)
* プラットフォームサービス
...
何から始めたらいいかわからない？ [カスタマーポータルから始めよう](./tailored-solution-highlights/customer-portals.md).
