...
Use the Liferay user data tools to manage and delete personal user data. Note, though these tools are aimed at helping you with GDPR requirements but they do not guarantee compliance. See [managing user data](https://learn.liferay.com/dxp/latest/en/users-and-permissions/managing-user-data.html) to learn more.

## Exporting User Data

You may need to export personal user data. For example, a former employee of Delectable Bonsai is requesting a copy of all their personal data. Follow the steps to export user data.
...
4. In the next page, select all the items you wish to export. For example, select all personal data from blogs or documents and media. Click _Export_ after making your selection.
...
Choose to anonymize personal data if you have a want to keep existing content. For example, you want to keep blog posts of a former employee without their personal data. Follow the steps to anonymize data.
...
3. The next page shows all the personal data associated with the user. Select each category you wish to delete (e.g. Select message boards).
