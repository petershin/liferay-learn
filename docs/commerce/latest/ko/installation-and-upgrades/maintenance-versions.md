...
1. `${liferay.home}/osgi/state` 폴더를 삭제합니다. > OSGi 폴더에 대한 자세한 내용은 [수동으로 앱 설치](https://help.liferay.com/hc/ko/articles/360017895412-Installing-Apps-Manually#using-your-file-system-to-install-apps) 를 참조하십시오.
1. 애플리케이션 서버를 시작하십시오.
