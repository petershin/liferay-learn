...
작업은 매우 유연하며 노드에 들어가기 전, 노드를 종료한 후 또는 작업 노드가 할당된 후 작업이 발생하는 시기를 지정할 수 있습니다. 예를 들어 검토자가 웹 콘텐츠 기사를 거부하면 워크플로 작업은 자산의 상태를 _보류_ 로 설정하고 기사를 원래 작성자에게 자동으로 재할당합니다.
...
1. _전역 메뉴_ &rarr; _응용 프로그램_ &rarr; _프로세스 빌더_로 이동합니다.
1. _워크플로_ 탭을 클릭합니다.
1. 워크플로 정의(예: _단일 승인자_)를 클릭합니다.
1. _업데이트_ 노드를 클릭합니다.
...
_업데이트_ 작업 노드에 알림을 추가하여 자산 생성자에게 제출물에 더 많은 작업이 필요하고 그에게 다시 할당되었음을 알립니다.
