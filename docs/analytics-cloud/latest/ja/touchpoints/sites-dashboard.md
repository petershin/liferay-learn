...
Liferay Analytics Cloudでは、ワークスペース内の各プロパティに対してサイトダッシュボードを提供しています。 例えば、 [プロパティを作成](../workspace-settings/scoping-sites-and-individuals-using-properties.md#creating-a-property) する時、各プロパティは、1つのサイトに関連付けることも、複数のサブサイトからデータを集約するように設定することもできます。
...
[興味のあるトピックの理解](../people/individuals/understanding-interests/)