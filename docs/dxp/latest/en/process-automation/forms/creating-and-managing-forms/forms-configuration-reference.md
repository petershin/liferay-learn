...
| [Liferay 7.4 Only] Submissions | Limit to One Submission per User | Require that only logged in users can fill out the form, and do not allow multiple form submissions. Users visiting the form after submitting see a warning message. You can customize the message. |
