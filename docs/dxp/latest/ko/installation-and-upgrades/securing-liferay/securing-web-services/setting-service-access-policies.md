...
*서비스 액세스 정책* 은 원격으로 호출할 수 있는 서비스 또는 서비스 방법을 정의합니다. 한 번에 여러 가지를 적용하여 결합된 효과를 낼 수 있습니다. 웹 서비스에 대한 보안</a> (IP 권한 다음)의

초 계층입니다. 사용자 지정 서비스 액세스 정책은 포털 관리자가 만들 수 있습니다. 포털의 토큰 인증자(OAuth 2)에 의해 적용됩니다.</p> 
...
1. _제어판_ &rarr; _시스템 설정_ &rarr; _API 인증_으로 이동합니다.
   ...
   ![서비스 액세스 정책 모듈 위치](./setting-service-access-policies/images/02.png)
