...
Liferay의 다양한 기능과 도구를 사용하여 비즈니스 요구에 맞는 실제 솔루션을 구축하십시오. 맞춤형 애플리케이션 샘플을 확인하고 제작 방법을 알아보세요.

::::{grid} 2
:gutter: 3 3 3 3

:::{grid-item-card}  맞춤형 티켓팅 시스템 구축
:link: ./tutorials/building-a-custom-ticketing-system.md
:::

:::{grid-item-card}  휴가 요청자 구축
:link: ./tutorials/building-a-time-off-requester.md
:::

:::{grid-item-card}  React 차트에서 객체 데이터 사용하기
