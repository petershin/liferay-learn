...
| 권한 범위          | 역할 유형    | 사용자에게 할당되는 위치는 어디입니까?                              | 사용 가능한 과제                                                                 |
|:-------------- |:-------- |:-------------------------------------------------- |:------------------------------------------------------------------------- |
...
사이트 범위 역할을 사이트 역할이라고 합니다. 사이트 역할에 대한 권한은 전역 수준에서 정의되며</a>
적용됩니다. 개별 사용자, 조직 및 사용자 그룹을 사용하여 사이트 구성원을 제어하고 사이트 역할을 할당할 수 있습니다.</p> 
