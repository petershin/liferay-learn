...
Liferay Cloud は、SAML 2.0 に準拠した Signle Sign-On Identity Provider をサポートしています。 詳細については、 [Liferay CloudでSSOを使用する](../infrastructure-and-operations/security/using-sso-with-liferay-cloud.md) をご覧ください。
