...
1. 게시판 **새 스레드** 버튼을 클릭합니다. **메시지 추가** 양식이 나타납니다.
1. **제목** 필드에 제목을 입력합니다.
...
1. 스레드와 관련된 포털의 기존 자산(예: 미디어 파일, 블로그 게시물 등)을 선택하려면 **관련 자산** 섹션을 확장하고 **선택** 버튼을 사용하여 해당 자산을 선택합니다.
...
1. **새 스레드** 버튼을 클릭합니다.
1. **추가 설정** 섹션을 확장합니다.
1. **Mark as a Question** 상자를 선택하십시오.
