...
**ブループリント**: 検索ブループリントはLiferayの検索動作の設計計画書です。 検索体験は、ほとんどのユーザーにとって、 [検索バー](../../../getting-started/searching-for-content.md#using-the-search-bar) から始まります。 検索語が入力されると、Liferayの検索インフラストラクチャによって複雑なクエリが構築され、検索エンジンに送信されます。 [Search Insights](../../../search-pages-and-widgets/search-insights.md) ウィジェットを使って、Liferayの完全なクエリを見ることができます。 このクエリはLiferayの検索ページのデフォルトのブループリントと考えることができ、何がどのように検索されるかを制御します。
