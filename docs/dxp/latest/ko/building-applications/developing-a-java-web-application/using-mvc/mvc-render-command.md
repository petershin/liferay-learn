...
MVC 렌더링 명령은 렌더링할 페이지를 처리하는 클래스입니다. `MVCPortlet` 렌더링 URL 및 요청에 의해 호출됩니다. 렌더링 로직이 단순하다면</a>클래스에서 모두
수 있습니다. 렌더링 논리가 복잡하거나 렌더링 경로를 깔끔하게 분리하려면 MVC 렌더링 명령을 사용하세요.</p> 
