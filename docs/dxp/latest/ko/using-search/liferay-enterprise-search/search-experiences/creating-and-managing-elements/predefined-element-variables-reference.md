...
| 현재 요일 | 숫자: 요일 반환(**1 = Monday**) | `${time.current_day_of_week}` |
...
**\*** [Liferay Commerce Enterprise 활성화](https://learn.liferay.com/commerce/latest/ko/installation-and-upgrades/activating-liferay-commerce-enterprise.html) 를 활성화하여 Commerce 관련 변수에 액세스합니다.
...
**\*\*** 이러한 기본 변수 외에도 [사용자 정의 필드](../../../../system-administration/configuring-liferay/adding-custom- field.md)를 요소의 변수로 참조할 수도 있습니다. 예를 들어 이름이***Employee** 인 사용자 정의 필드는 `user.custom.field.employee`가 있는 요소에서 참조됩니다. 
