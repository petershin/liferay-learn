...
```{note}
An [upgrade process](../../../liferay-development/building-applications/data-frameworks/upgrade-processes.md) is in place that moves existing forms to the Liferay 7.4 Default storage adapter.
```
