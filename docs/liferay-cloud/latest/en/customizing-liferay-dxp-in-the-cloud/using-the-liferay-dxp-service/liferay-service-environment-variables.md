...
| `LCP_LIFERAY_JDBC_CONNECTION_URL_QUERY_STRING`                             | _(Default query string only for MySQL)_                                                | Configures the JDBC connection query string.                                                                                                                                                                                                                               |
...
| `LIFERAY_JDBC_PERIOD_DEFAULT_PERIOD_URL`                                   | PostgreSQL: `jdbc:postgresql://database--route`; MySQL: `jdbc:mysql://database--route` | Changes the `jdbc.default.url` Liferay [portal property](https://learn.liferay.com/web/guest/w/dxp/installation-and-upgrades/reference/portal-properties) to override the JDBC URL. _Changing this can cause Liferay to fail to connect to the database._                  |
