...
1. In the new window, input `Marvelous Markets NYC` for account name. Click _Save_.
...
1. Navigate to _Global Menu_ (![Global Menu](../../images/icon-applications-menu.png)) &rarr; _Control Panel_ &rarr; _Account Users_. Click _Add User_ (![Add icon](../../images/icon-add.png)). Click _Choose_ next to Marvelous Markets NYC.
...
1. Navigate to _Global Menu_ (![Global Menu](../../images/icon-applications-menu.png)) &rarr; _Control Panel_ &rarr; _Accounts_. Click on _Marvelous Markets NYC_. Click the _Roles_ tab. Click _Order Manager_.
...
1. Give the name `Marvelous Markets East Coast` for the account group name. Click _Save_.

1. Click the _Accounts_ tab and click _Assign Account_ (![Add icon](../../images/icon-add.png)). In the new window, select _Marvelous Markets NYC_ and click _Assign_. In this way, multiple Marvelous markets in the east coast region an be added to the group.

In addition to account roles, an account manager role can be assigned to a whole organization. Therefore, in a situation where an entity (e.g. Marvelous Markets) has multiple accounts, create an organization for the accounts to be a part of. Then assign an account manager to that organization. 

1. Navigate to _Global Menu_ (![Global Menu](../../images/icon-applications-menu.png)) &rarr; _Control Panel_ &rarr; _Users and Organizations_. Click the _Organizations_ tab. Click _Add_ (![Add icon](../../images/icon-add.png)). Input `Marvelous Markets` in the _Name_ field. Click _Save_.

1. Navigate to _Control Panel_ &rarr; _Accounts_. Click _Marvelous Markets NYC_. Click the _Organizations_ tab. Click _Assign Organizations_ (![Add icon](../../images/icon-add.png)). 
...
1. Now make Lily Lewis an account manager. Navigate to _Control Panel_ &rarr; _Users and Organizations_. Click on _Lily Lewis_. Click _Organizations_ in the left navigation. Click _Select_ and click _Choose_ next to Marvelous Markets. Click _Save_. Lily Lewis is now also part of the Marvelous Markets organization.
...
1. Click _Roles_ in the left navigation. Click _Select_ next to organization roles. Click _Choose_ next to Account Manager. Click _Save_. 
   ...
   Lily Lewis is now an account manager for all accounts in the Marvelous Markets organization. The account manager can take actions, such as placing orders, on behalf of accounts. 
