...
Liferayは、電子メールによるワンタイムコードと、SMSや認証アプリをサポートするサードパーティサービスの両方をサポートしています。 詳しくは、 [多要素認証の使用](https://learn.liferay.com/w/dxp/installation-and-upgrades/securing-liferay/multi-factor-authentication/using-multi-factor-authentication) をご覧ください。
...
1. **Enabled** にチェックを入れ、 **Save** をクリックします。 設定オプションの詳細については、 [多要素認証の使用](https://learn.liferay.com/w/dxp/installation-and-upgrades/securing-liferay/multi-factor-authentication/using-multi-factor-authentication#enabling-multi-factor-authentication) を参照してください。
...
- [多要素認証チェッカー](https://learn.liferay.com/w/dxp/installation-and-upgrades/securing-liferay/multi-factor-authentication/multi-factor-authentication-checkers)
