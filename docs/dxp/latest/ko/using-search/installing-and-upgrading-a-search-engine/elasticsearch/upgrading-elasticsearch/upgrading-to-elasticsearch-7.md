...
Elasticsearch 7은 즉시 사용 가능한 최신 Liferay 7.2, 7.3 및 7.4 버전에서 지원됩니다. 특정 버전 호환성에 대한 자세한 내용은 [검색 엔진 호환성 매트릭스](https://help.liferay.com/hc/ko/articles/360016511651) 을 참조하십시오.
