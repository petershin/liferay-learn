...
1. 생성한 `language.properties` 파일로 언어 모듈을 생성하고 모듈을 Liferay 설치에 배포합니다. 이 모듈 생성에 대한 샘플 프로젝트 및 특정 지침을 보려면 [Overriding Global Language Translations](../../../liferay-internals/extending-liferay/overriding-global-language-translations.md) 참조하십시오.
