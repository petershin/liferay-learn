...
1. _사이트 관리_ &rarr; _콘텐츠 및 데이터_  &rarr; _양식_로 이동합니다.
1. 오른쪽 상단의 ![Options](../../../images/icon-options.png) 아이콘을 클릭한 다음 _내보내기/가져오기_를 클릭합니다.
...
1. 원하는 폴더를 선택한 다음 확인 상자에서 _확인_ 을 클릭합니다.
...
1. 다른 사이트로 이동합니다.
1. _사이트 관리_ &rarr; _콘텐츠 및 데이터_  &rarr; _양식_로 이동합니다.
1. 오른쪽 상단의 ![Options](../../../images/icon-options.png) 아이콘을 클릭합니다. &rarr; _내보내기/가져오기_.
1. _가져오기_ 탭을 클릭합니다.
1. `LAR` 파일을 끌어다 놓거나 _파일_ 을 선택하여 사이트를 찾습니다.
1. _계속_을 클릭합니다.
1. _업데이트 데이터_ 섹션을 펼치십시오.
1. _미러_ (권장)을 클릭합니다.

   ![권장 설정을 사용하여 LAR을 가져옵니다.](./exporting-and-importing-forms/images/03.png)

1. _가져오기_을 클릭합니다.
1. _내보내기/가져오기_ 창을 클릭합니다.
