...
commerce・コンテキストでは、チャネルイベントに対する通知がサポートされています。 詳しくは、 [メールの保存](https://learn.liferay.com/commerce/latest/ja/store-management/sending-emails/store-emails.html) をご覧ください。
