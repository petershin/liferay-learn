...
Liferay의 Headless Delivery 애플리케이션은 [Message Boards](../../message-boards.md) 애플리케이션에 대한 REST 서비스를 제공합니다. 이러한 서비스를 사용하면 게시판 카테고리, 스레드 및 메시지를 추가하고 해당 정보를 나열하며 내용을 수정하거나 완전히 제거할 수 있습니다. 여기에서는 cURL 명령과 Java 클래스를 사용하여 해당 서비스를 호출합니다.
