...
1. _［Suspended］_または_［Cancelled］_を_［Status］_ドロップダウンメニューから選択してください。
...
1. _［Shipments］_タブをクリックします。 ここから、店舗管理者は出荷状況を追跡できます。

    ![出荷状況の追跡を変更できます。](managing-subscriptions/images/05.png)

### 支払履歴の追跡

1. _［Payments］_ タブをクリックします。 ここから、店舗管理者は支払履歴を追跡できます。
