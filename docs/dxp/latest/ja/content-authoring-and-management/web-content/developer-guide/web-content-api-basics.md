...
詳しくは、 [基本的なWebコンテンツ記事の追加](../web-content-articles/adding-a-basic-web-content-article.md)を参照してください。
...
- このWebコンテンツは、`contentStructureId`で特定されるデフォルトのLiferay DXPWebコンテンツストラクチャーを使用します。
