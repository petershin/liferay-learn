...
See [Payments Reference](./payments-reference.md) for more information on these fields. Only payments of supported types appear on the Payments page. See [Refunds](./payment-management/refunds.md) to know more about creating refunds on these payments. 

!!! important

    PayPal is the only out-of-the-box payment type that supports refunds.
