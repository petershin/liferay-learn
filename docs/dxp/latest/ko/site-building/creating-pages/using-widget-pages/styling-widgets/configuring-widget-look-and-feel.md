...
위젯의 모양과 느낌 구성 메뉴에 액세스하려면 다음 단계를 따르십시오.

1.  위젯의 오른쪽 상단 모서리에 있는 *옵션* 아이콘(![Actions Button](../../../../images/icon-actions.png))을 클릭합니다.
...
1. 사용자 지정을 한 후 *저장* 을 클릭하고 페이지를 새로 고쳐 변경 사항을 적용합니다.
...
**사용자 지정 제목 사용** 은 위젯 제목을 변경할 수 있습니다. 제목 상자의 값은 위젯의 데코레이터에 표시됩니다. 제목은 현지화할 수 있으므로 다른 언어로 번역된 제목을 제공할 수 있습니다.

**애플리케이션 데코레이터** 은 세 가지 데코레이터 중에서 선택할 수 있습니다: *Barebone*, *Borderless*, *Decorate*. Decorate 애플리케이션 데코레이터가 기본값입니다.
...
*텍스트 스타일* 위젯에 표시되는 텍스트의 형식을 구성합니다. 옵션에는 다음이 포함됩니다.
...
![텍스트 스타일 탭에서는 위젯에 표시되는 텍스트의 형식을 구성할 수 있습니다.](./configuring-widget-look-and-feel/images/02.png)
...
![테두리 스타일 탭에서는 위젯의 각 측면에 대한 테두리 너비, 스타일 및 색상을 지정할 수 있습니다.](./configuring-widget-look-and-feel/images/04.png)
...
![여백 및 안쪽 여백 탭에서는 위젯 측면의 여백 및 안쪽 여백 길이를 지정할 수 있습니다.](./configuring-widget-look-and-feel/images/05.png)
...
![그림 6: 고급 스타일링 탭에는 위젯의 Liferay ID가 표시되며 CSS 코드를 입력하여 위젯의 모양과 느낌을 사용자 정의할 수 있습니다.](./configuring-widget-look-and-feel/images/06.png)
