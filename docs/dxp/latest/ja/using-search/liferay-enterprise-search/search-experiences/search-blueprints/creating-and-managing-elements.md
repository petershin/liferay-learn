...
エレメントは、 [Search Blueprints](understanding-search-blueprints.md) の基本的な構成要素の一つで、Blueprintsアプリケーション内で管理されます。 グローバルメニューの「アプリケーション」セクションを開き、「Search Experiences」カテゴリーを見つけて「Search Blueprints」を開きます。 _Elements_ タブをクリックすると、新しいElementを追加し、既存のElementを管理することができます。
