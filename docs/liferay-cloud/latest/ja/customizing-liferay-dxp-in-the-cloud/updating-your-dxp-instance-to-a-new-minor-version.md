...
1. リポジトリで、 `liferay.workspace.docker.image.liferay` のプロパティの値を、 [`liferay/gradle.properties`](../customizing-liferay-dxp-in-the-cloud/using-the-liferay-dxp-service.md#choosing-a-version) の新しいバージョンのタグに変更します：
...
* [Liferay Cloudのクラスタリングの設定](./setting-up-clustering-in-liferay-cloud.md)
