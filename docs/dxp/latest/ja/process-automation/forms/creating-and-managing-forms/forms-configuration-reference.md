...
サイト間でフォームをエクスポートおよびインポートすることができます。 **エクスポート/インポート** メニューにアクセスするには、 ［**サイト管理**］ &rarr; ［**コンテンツとデータ**］ &rarr; ［**フォーム**］ に進みます。 右上の![Options](../../../images/icon-options.png)アイコンをクリックし、 ［**エクスポート/インポート**］ をクリックします。

![フォームをエクスポートおよびインポートできます。](./forms-configuration-reference/images/01.png)

詳しくは、 [フォームのエクスポートとインポート](./exporting-and-importing-forms.md) および [サイトページとコンテンツのエクスポートとインポート](../../../site-building/sites/exporting-importing-site-pages-and-content.md) を参照してください。
...
| 共通                | [ワークフロー](../sharing-forms-and-managing-submissions/using-forms-with-a-workflow.md)の選択 | フォームの送信を確認するためのワークフロー定義を選択します。ワークフローはデフォルトでは無効になっています。                                                                                                                      |
...
| 送信（Liferay 7.4のみ） | 回答者に一部の結果を表示します。                                                                      | 回答者に、フォームの現在の [フォームレポート](../sharing-forms-and-managing-submissions/form-reports.md#show-partial-results-to-form-respondents) データを表示できるようにします。 この機能を有効にすると、機密情報を送信しないように警告します。 |
...
1. **グローバルメニュー**（![global icon](../../../images/icon-applications-menu.png)）&rarr; ［**コントロールパネル**］ に移動します。
1. ［**システム設定**］ をクリックします。
1. ［**コンテンツとデータ**］ セクションで ［**Forms**］ をクリックします。
