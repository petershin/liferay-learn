...
| `auto.login.hooks` | See [setting](https://github.com/liferay/liferay-portal/blob/[$LIFERAY_LEARN_PORTAL_GIT_TAG$]/portal-impl/src/portal.properties) | See [setting](https://github.com/liferay/liferay-portal/blob/[$LIFERAY_LEARN_PORTAL_GIT_TAG$]/portal-impl/src/portal.properties) |
...
| `dl.email.file.entry.expired.body` | Not applicable | See [setting](https://github.com/liferay/liferay-portal/blob/[$LIFERAY_LEARN_PORTAL_GIT_TAG$]/portal-impl/src/portal.properties) |
| `dl.email.file.entry.expired.enabled` | Not applicable | `true` |
| `dl.email.file.entry.expired.subject` | Not applicable | See [setting](https://github.com/liferay/liferay-portal/blob/[$LIFERAY_LEARN_PORTAL_GIT_TAG$]/portal-impl/src/portal.properties) |
| `dl.email.file.entry.review.body` | Not applicable | See [setting](https://github.com/liferay/liferay-portal/blob/[$LIFERAY_LEARN_PORTAL_GIT_TAG$]/portal-impl/src/portal.properties) |
| `dl.email.file.entry.review.enabled` | Not applicable | `true` |
| `dl.email.file.entry.review.subject` | Not applicable | See [setting](https://github.com/liferay/liferay-portal/blob/[$LIFERAY_LEARN_PORTAL_GIT_TAG$]/portal-impl/src/portal.properties) |
| `dl.file.entry.preview.audio.mime.types` | See [setting](https://github.com/liferay/liferay-portal/blob/[$LIFERAY_LEARN_PORTAL_GIT_TAG$]/portal-impl/src/portal.properties) | Added value `audio/vnd.wave` |
...
| `dl.file.entry.preview.video.mime.types` | See [setting](https://github.com/liferay/liferay-portal/blob/[$LIFERAY_LEARN_PORTAL_GIT_TAG$]/portal-impl/src/portal.properties) | Added value `video/theora` |
...
| `jsonws.web.service.parameter.type.whitelist.class.names` | See [setting](https://github.com/liferay/liferay-portal/blob/[$LIFERAY_LEARN_PORTAL_GIT_TAG$]/portal-impl/src/portal.properties) | See [setting](https://github.com/liferay/liferay-portal/blob/[$LIFERAY_LEARN_PORTAL_GIT_TAG$]/portal-impl/src/portal.properties) |
...
| `module.framework.properties.org.osgi.framework.bootdelegation` | See [setting](https://github.com/liferay/liferay-portal/blob/[$LIFERAY_LEARN_PORTAL_GIT_TAG$]/portal-impl/src/portal.properties) | Removed value `com.sun.syndication` |
| `module.framework.web.generator.excluded.paths` | See [setting](https://github.com/liferay/liferay-portal/blob/[$LIFERAY_LEARN_PORTAL_GIT_TAG$]/portal-impl/src/portal.properties) | See [setting](https://github.com/liferay/liferay-portal/blob/[$LIFERAY_LEARN_PORTAL_GIT_TAG$]/portal-impl/src/portal.properties) |
...
| `openoffice.conversion.source.extensions[text]` | See [setting](https://github.com/liferay/liferay-portal/blob/[$LIFERAY_LEARN_PORTAL_GIT_TAG$]/portal-impl/src/portal.properties) | See [setting](https://github.com/liferay/liferay-portal/blob/[$LIFERAY_LEARN_PORTAL_GIT_TAG$]/portal-impl/src/portal.properties) |
...
| `redirect.url.ips.allowed` | See [setting](https://github.com/liferay/liferay-portal/blob/[$LIFERAY_LEARN_PORTAL_GIT_TAG$]/portal-impl/src/portal.properties) | Removed property |
...
| `session.phishing.protected.attributes` | See [setting](https://github.com/liferay/liferay-portal/blob/[$LIFERAY_LEARN_PORTAL_GIT_TAG$]/portal-impl/src/portal.properties) | See [setting](https://github.com/liferay/liferay-portal/blob/[$LIFERAY_LEARN_PORTAL_GIT_TAG$]/portal-impl/src/portal.properties) |
| `session.timeout.auto.extend.offset` | `10` | `70` |
| `system.role.Publications.User.description` | Not applicable | See [setting](https://github.com/liferay/liferay-portal/blob/[$LIFERAY_LEARN_PORTAL_GIT_TAG$]/portal-impl/src/portal.properties) | |
...
| `transactional.cache.names` | See [setting](https://github.com/liferay/liferay-portal/blob/[$LIFERAY_LEARN_PORTAL_GIT_TAG$]/portal-impl/src/portal.properties) | See [setting](https://github.com/liferay/liferay-portal/blob/[$LIFERAY_LEARN_PORTAL_GIT_TAG$]/portal-impl/src/portal.properties) |
