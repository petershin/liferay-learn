...
The next tool that every seller must master is using a Data Enrichment tool correctly.

For those unfamiliar with this terminology, a data enrichment tool is a software that provides you with professional emails and direct phone numbers for prospects.
...
If you do not have a data enrichment tool it means that you have no way of acquiring prospect contact information. If you don’t have contact information, you have no way of contacting a prospect. And if you have no way of contacting them you can’t do outbound prospecting.

### Using Data Enrichment tools correctly

The use of data enrichment tools is quite normal. Indeed, they should be considered a necessity and not a nice-to-have.
...
If you are a seller, and your job is to prospect, never prospect someone where you don’t have both their direct phone and their business email.  A Data Enrichment tool will provide this contact information, which in turn supports a multi-channel prospecting approach.
...
Next: we’ll look at the use of [Social Media](./social-media.md) for prospecting purposes.
