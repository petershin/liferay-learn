...
1. 개체 항목에 대한 기록을 활성화하거나 비활성화합니다.
   ...
   활성화된 동안 Liferay는 감사 응용 프로그램에서 또는 REST API 호출을 통해 볼 수 있는 항목 이벤트 기록을 유지합니다. [개체 정의 이벤트 감사](./auditing-object-definition-events.md)을 참조하십시오. 

   ```{important}
   7.4 U72+/GA72+의 경우 언제든지 이 설정을 구성할 수 있습니다. 이전 버전의 경우 게시하기 전에만 이 설정을 구성할 수 있습니다.
   ```
