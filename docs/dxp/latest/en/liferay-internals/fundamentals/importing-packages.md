...
Conveniently, [Workspace](../../liferay-development/tooling/liferay-workspace/what-is-liferay-workspace.md)-based module projects automatically detect required packages and add them to the module manifest's package import list. Sometimes, they must be specified manually.
...
- [Blade CLI](../../liferay-development/tooling/blade-cli/generating-projects-with-blade-cli.md)
- [Workspace](../../liferay-development/tooling/liferay-workspace/what-is-liferay-workspace.md)
