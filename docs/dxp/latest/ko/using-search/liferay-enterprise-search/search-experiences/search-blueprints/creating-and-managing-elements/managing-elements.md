...
기존 요소를 복제하려면 _작업_ (![Actions](../../../../images/icon-actions.png))을 클릭하고 _복사_선택합니다. 다른 맞춤 요소와 마찬가지로 복제된 요소를 삭제하거나 편집할 수 있습니다.

요소를 내보내려면 해당 요소에 대해 _작업_ (![Actions](../../../../images/icon-actions.png))을 클릭하고 _내보내기_선택합니다.

요소를 가져오려면 화면 상단 모서리(전역 메뉴 아이콘 옆)에서 _작업_ (![Actions](../../../../images/icon-actions.png))을 클릭합니다. _가져오기_ 클릭하고 요소의 JSON 파일을 찾습니다.
