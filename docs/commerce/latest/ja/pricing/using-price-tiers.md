...
価格表（_VIP Customers_）の商品（_Premium Brake Fluid_）の最小数量（20）に達する注文に対して価格レート（90ドル）が作成されました。 連続する価格レートを同じ商品および価格表に追加したり（他の最小数において）、価格レートを別の商品および価格表に追加するには、上記の手順を繰り返します。
