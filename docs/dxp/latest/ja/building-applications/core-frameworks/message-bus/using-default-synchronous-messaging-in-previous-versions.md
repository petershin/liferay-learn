...
*direct* モードを使用した同期メッセージングを検討したい場合は、 [Using Direct Synchronous Messaging in Previous Versions](./using-direct-synchronous-messaging-in-previous-versions.md)を参照してください。
