...
デフォルトでは、サイトメンバーはページをカスタムすることができますが、サイト以外のメンバーとゲストは行うことができません。 管理者は、既存のロールの権限を更新したり、 [新しいロール](../../../../users-and-permissions/roles-and-permissions/creating-and-managing-roles.md) を作成して他のユーザーに割り当て、ページのカスタマイズを可能にすることができます。 以下の手順で、ページのカスタマイズにロール権限を付与します。
