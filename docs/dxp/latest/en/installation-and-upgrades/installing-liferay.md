...
```{note}
Enterprise subscribers can [deploy Liferay DXP as a service](https://learn.liferay.com/en/w/liferay-cloud/using-the-liferay-dxp-service) on Liferay Cloud. Liferay Cloud reduces infrastructure costs (hardware, electricity bills), scales fast to handle more customers, provides a faster time to market, and is easy use.
