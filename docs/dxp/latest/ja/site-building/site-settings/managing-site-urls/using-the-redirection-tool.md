...
SEOの各リダイレクトタイプの影響の詳細については、[Optimizing Sites](../../optimizing_sites.html)を参照してください。 また、テスト時に302コードを使用する方法については、[A/B Testing](../../optimizing-sites/ab-testing/ab-testing.md)を参照してください。
