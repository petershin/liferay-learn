...
Liferay DXP 인스턴스를 처음 시작하고 구성하면 기본 사이트가 포함됩니다. 기본적으로 인스턴스 이름은 _Liferay_이지만 이 값은 설치 마법사의 구성이나 제어판의 [인스턴스 설정](../system-administration/configuring-liferay/virtual-instances/instance-configuration.md) 통해 변경할 수 있습니다.
