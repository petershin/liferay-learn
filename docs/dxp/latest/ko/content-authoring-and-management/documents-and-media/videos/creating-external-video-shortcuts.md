...
Liferay의 문서 및 미디어 응용 프로그램을 사용하면 외부 플랫폼에서 호스팅되는 비디오에 대한 참조를 저장할 수 있습니다. 그런 다음 이러한 참조를 사용하여 [](./embedding-videos-into-liferay-assets-and-pages.md) 또는 사이트 페이지에 비디오를 포함할 수 있습니다. YouTube, Facebook, Vimeo 및 Twitch는 기본적으로 지원되지만 이 기능을 확장하여 사용자 지정 비디오 소스를 지원할 수 있습니다.<!--TASK: link to dev article once merged, "\[support custom video sources\](./creating-custom-video-shortcut-providers.md)"-->외부 비디오 바로 가기를 만들려면 다음 단계를 따르십시오.
...
1. *추가* 버튼(![Add Button](../../../images/icon-add.png))을 클릭하고 *외부 비디오 바로 가기*를 선택합니다.

   ![새 외부 비디오 바로 가기를 추가합니다.](./creating-external-video-shortcuts/images/01.png)

1. 지원되는 플랫폼(YouTube, Vimeo, Facebook 또는 Twitch)의 동영상 URL을 입력하세요.
...
1. (선택 사항) 비디오의 표시 페이지 템플릿을 선택합니다.

   선택한 템플릿은 고유하고 친숙한 URL에 비디오를 표시하고 표시 페이지의 레이아웃을 정의합니다. 자세한 내용은 [디스플레이 페이지 템플릿 생성 및 관리](../../../site-building/displaying-content/using-display-page-templates/creating-and-managing-display-page-templates.md) 을 참조하십시오.

   ![비디오의 디스플레이 페이지 템플릿을 선택합니다.](./creating-external-video-shortcuts/images/03.png)

1. (선택사항) 태그 [개와 카테고리](../../tags-and-categories/organizing-content-with-categories-and-tags.md)개를 사용하여 동영상 바로가기를 분류합니다.

1. (선택 사항) 동영상 바로가기에 대한 관련 자산을 선택합니다.

1. (선택 사항) 비디오 바로 가기에 대한 권한을 구성합니다.
