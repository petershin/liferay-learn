...
You can use Price Modifiers to target a *Catalog*, *Category*, *Product Group* or *Product*. The Price Modifier is applied to all Products in the Target group. This is unlike in the Entries section where you have to target each SKU specifically. See [Adding a Price Modifier](./creating-a-promotion.md#adding-a-price-modifier) for more information.
