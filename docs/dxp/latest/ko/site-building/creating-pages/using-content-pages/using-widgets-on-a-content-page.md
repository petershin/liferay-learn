...
<!--TASK: Reconsider-->
위젯 섹션은 위젯 페이지</a>의
*추가* 메뉴와 같은 기능을 합니다. 사용 가능한 위젯의 전체 목록이 나타나고 페이지에 추가할 수 있습니다. 주요 차이점은 위젯의 기본 구성 옵션만 콘텐츠 페이지에서 사용할 수 있다는 것입니다.</p> 
...
1. 콘텐츠 페이지에 요소를 추가하는 동안 [위젯 패널을](./adding-elements-to-content-pages.md) </a>가능한 위젯을 찾아보거나 이름으로 위젯을 검색 .</li> 
   
   1 위젯을 배치하려는 레이아웃의 열과 행으로 위젯을 드래그합니다.</ol> 
