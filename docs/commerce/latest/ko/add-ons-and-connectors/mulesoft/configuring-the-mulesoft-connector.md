...
이러한 문서는 배포된 RESTful 웹 서비스를 기반으로 하므로 API에 대한 가장 정확한 설명입니다. Liferay API [여기](https://learn.liferay.com/dxp/latest/en/headless-delivery/consuming-apis.html)에 대해 자세히 알아볼 수 있습니다.
...
프로덕션의 경우 [OAuth2](https://learn.liferay.com/dxp/latest/en/headless-delivery/using-oauth2.html)을 통해 사용자를 인증해야 합니다. 기본 인증은 기본 테스트 및 데모용으로만 제공됩니다.
...
OAuth2 인증으로 엔드포인트를 사용하려면 필요한 인증 옵션으로 [범위](https://learn.liferay.com/dxp/latest/en/headless-delivery/using-oauth2/oauth2-scopes.html) 도 정의해야 합니다(예: `every`, `everything.write`또는 `every.read`).

자세한 설정 지침은 [OAuth2 애플리케이션 만들기](https://learn.liferay.com/dxp/latest/en/headless-delivery/using-oauth2/creating-oauth2-applications.html) 참조하고, OAuth2를 사용하는 샘플 React 애플리케이션은 [OAuth2를 사용하여 사용자 인증](https://learn.liferay.com/dxp/latest/en/headless-delivery/using-oauth2/using-oauth2-to-authorize-users.html) 참조하세요.
...
* [API 소비](https://learn.liferay.com/dxp/latest/en/headless-delivery/consuming-apis.html)
* [OAuth2 사용](https://learn.liferay.com/dxp/latest/en/headless-delivery/using-oauth2.html)
