...
!!! note
    This process varies for different Liferay DXP versions, though prerequisites are the same. See [Connecting Liferay DXP 7.3 to Analytics Cloud](./connecting-liferay-dxp-7-3-to-analytics-cloud.md) for alternative instructions.
