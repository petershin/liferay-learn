...
Use the `liferay new` command to create a new [Client Extension](../../client-extensions.md) or Liferay Platform project:
...
1. Choose whether to create a Remote App project or a Liferay Platform project.
   ...
   ```{note}
   [Client Extensions](../../client-extensions.md) are hosted on a remote server that your Liferay DXP instance can access to use as an application. Liferay Platform projects are deployable to Liferay DXP/Portal.
   ```
