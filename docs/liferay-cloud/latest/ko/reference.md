...
- [Liferay 클라우드 스택 업그레이드](./reference/upgrading-your-liferay-cloud-stack.md)
- [Liferay 클라우드 버전 5 변경 사항](./reference/liferay-cloud-version-5-changes.md)
- [버전 4의 Liferay Cloud 프로젝트 변경 사항](./reference/liferay-cloud-project-changes-in-version-4.md)
- [고가용성 구독으로 업그레이드](./reference/upgrading-to-a-high-availability-subscription.md)
- [명령줄 도구](./reference/command-line-tool.md)
- [환경 변수 정의](./reference/defining-environment-variables.md)
- [플랫폼 제한 사항](./reference/platform-limitations.md)
- [예제 구성 파일](./reference/example-configuration-files.md)
