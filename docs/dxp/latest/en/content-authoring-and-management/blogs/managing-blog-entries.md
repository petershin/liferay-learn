...
Bloggers and blog administrators manage blog entries using the Blogs application in the Site Administration menu. To access this app, click _Product Menu_ button ( ![Product Menu button](../../images/icon-product-menu.png) ) to open the product menu and select _Content & Data_ &rarr; _Blogs_.
...
1. Click _Trash_ button ( ![Trash button](../../images/icon-trash.png) ) to move the selected entries to the Recycle Bin.
...
1. Click _Actions_ menu ( ![Actions menu](../../images/icon-actions.png) ) and then _Share_.
