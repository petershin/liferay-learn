...
See [Deploying Changes via the Liferay Cloud Console](./deploying-changes-via-the-dxp-cloud-console.md) for a walk through of the deployment workflow.

![Deploy builds via the Liferay Cloud console.](./overview-of-the-dxp-cloud-deployment-workflow/images/02.png)
