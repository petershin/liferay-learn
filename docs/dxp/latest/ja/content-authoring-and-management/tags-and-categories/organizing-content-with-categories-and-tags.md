...
- **Public Visibility** : 訪問者は、公開カテゴリーを使用して、検索またはナビゲーションを通じてコンテンツを見つけることができます。 公開カテゴリーはすべての人に公開されます。
...
次のビデオは、ボキャブラリの可視性と組み込みの [グローバルボキャブラリ](#default-vocabularies) の概要を示しています。
